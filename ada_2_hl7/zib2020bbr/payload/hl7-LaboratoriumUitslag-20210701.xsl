...
<!--    <xsl:import href="../../zib2017bbr/2_hl7_zib2017bbr_include.xsl"/>-->
    ...
    <xd:doc>
        <xd:desc>Mapping of zib nl.zorg.LaboratoriumUitslag 4.6 concept in ADA to HL7 CDA template =======TODO========</xd:desc>
        <xd:param name="in">ADA Node to consider in the creation of the hl7 element</xd:param>
    </xd:doc>    
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.121.10.19_20210701000000" match="laboratorium_uitslag | laboratory_result" mode="HandleLaboratoryResult">
