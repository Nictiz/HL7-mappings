This is a preliminary version of converting Medicatievoorschrift from a relatively simple dataset xml format (based on functional definition of a MP 9 voorschrift transaction) to a HL7v3  message for a medicatievoorschrift version 6.12.8. It is based on the publication with timestamp 26-04-2018 14:09 (http://decor.nictiz.nl/medicatieproces/mp-html-20180426T140905/project.html).
...
The folder 'ada_instance' contains sample ada instance files. They are in no way functionally valid (i.e. the situation can probably not be validated in real life). The folder hl7_instance contains the result of the conversion for these sample files.
