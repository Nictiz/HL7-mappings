This is a preliminary version of converting sturen_medicatiegebruik from a relatively simple dataset xml format to a HL7v3 message/CDA. It is based on publication 9.0.6.
...
The folder "payload" contains the stylesheet that does the conversion for the payload: "sturen_medicatiegebruik_org.xsl"
