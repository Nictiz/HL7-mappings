...
<xsl:stylesheet xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:nf="http://www.nictiz.nl/functions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:template name="data">
        ...
        <rule context="/">
            ...
            <let name="hl7-aantal-mas" value="count(.//hl7:substanceAdministration[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9148'][hl7:consumable/hl7:manufacturedProduct/hl7:manufacturedMaterial//*[@code = $medCodeNr]])"/>
            ...
            <let name="hl7-aantal-vvs" value="count(.//hl7:supply[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9087'])"/>
    ...
    <xsl:function name="nf:ma-context">
        ...
        <xsl:variable name="base-context" select="'//hl7:substanceAdministration[hl7:templateId/@root = ''2.16.840.1.113883.2.4.3.11.60.20.77.10.9148''][hl7:consumable/hl7:manufacturedProduct/hl7:manufacturedMaterial//*[@code = $medCodeNr]]'"/>
    ...
    <xsl:function name="nf:vv-context">
        ...
        <!-- determine the correct context -->
        <xsl:variable name="base-context" select="'//hl7:supply[hl7:templateId/@root = ''2.16.840.1.113883.2.4.3.11.60.20.77.10.9087''][hl7:product/hl7:manufacturedProduct/hl7:manufacturedMaterial//*[@code = $medCodeNr]]'"/>
