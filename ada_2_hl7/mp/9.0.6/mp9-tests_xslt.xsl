...
<xsl:stylesheet xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:nf="http://www.nictiz.nl/functions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:include href="sturen_medicatievoorschrift/mp9-voorschrift-ada2test_xslt.xsl"/>
    <xsl:param name="mp9-tests" select="doc('sturen_medicatievoorschrift\mp9-tests-config.xml')"/>

    <xsl:template match="/">
        <!-- currently only support for sturen-voorschrift, but the predicate should not be necessary -->
        <xsl:for-each select=".//transactie[@name = 'sturen_voorschrift']/test">
