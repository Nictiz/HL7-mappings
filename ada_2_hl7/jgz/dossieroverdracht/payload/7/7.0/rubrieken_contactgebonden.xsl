                    ...
                    <xsl:for-each select="$activiteitActies">
                        <xsl:choose>
                            <xsl:when test="self::r012_erfelijke_belasting_en_ouderkenmerken">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11012_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
                            <xsl:when test="self::r013_bedreigingen_uit_de_directe_omgeving">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                            ...
                            <xsl:when test="self::r021_functioneren">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11021_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
                            <xsl:when test="self::r022_huidhaarnagels">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11022_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
                            <xsl:when test="self::r023_hoofdhals">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11023_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
                            <xsl:when test="self::r024_romp">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11024_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
                            <xsl:when test="self::r025_bewegingsapparaat">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11025_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
                            <xsl:when test="self::r026_genitaliapuberteitsontwikkeling">
                                <xsl:comment><xsl:text> </xsl:text><xsl:value-of select="local-name()"/><xsl:text> </xsl:text></xsl:comment>
                                <pertinentInformation>
                                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.11026_20200527000000"/>
                                </pertinentInformation>
                            </xsl:when>
