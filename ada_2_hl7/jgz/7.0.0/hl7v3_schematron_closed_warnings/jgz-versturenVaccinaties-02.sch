...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Versturen vaccinatie 413 (2.16.840.1.113883.2.4.3.11.60.100.4.48 2020-05-27T00:00:00)</title>
   ...
   <pattern>
      ...
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 ...
                 see="http://decor.nictiz.nl/pub/jeugdgezondheidszorg/jgz-html-20240426T081156/tmp-2.16.840.1.113883.2.4.6.10.100.14-2024-04-25T000000.html">(VersturenVaccinaties): In de instance werd het volgende element verwacht: descendant-or-self::hl7:REPC_IN002140NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.6.10.100.14-2024-04-25T000000.sch"/>
   <include href="include/2.16.840.1.113883.2.4.6.10.100.14-2024-04-25T000000-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.14-2024-04-25T000000"/>
   ...
   <phase id="VersturenVaccinaties-closed">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.14-2024-04-25T000000-closed"/>
   </phase>
