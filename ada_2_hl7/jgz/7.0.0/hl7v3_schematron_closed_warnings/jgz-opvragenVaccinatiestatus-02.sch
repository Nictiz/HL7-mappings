...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Opvragen Vaccinatiestatus 402 (2.16.840.1.113883.2.4.3.11.60.100.4.42 2020-05-27T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario opvragenVaccinatiestatus-02 -->
   <!-- OpvragenVaccinatiestatus -->
   <pattern>
      <title>OpvragenVaccinatiestatus</title>
   ...
   <include href="include/2.16.840.1.113883.2.4.6.10.100.16-2012-10-01T000000-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.16-2012-10-01T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.181-2012-09-01T000000"/>
   </phase>
   <phase id="OpvragenVaccinatiestatus">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.16-2012-10-01T000000"/>
   </phase>
   <phase id="OpvragenVaccinatiestatus-closed">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.16-2012-10-01T000000-closed"/>
   </phase>
   <phase id="OpvragenVaccinatiestatus-payload">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.181-2012-09-01T000000"/>
   </phase>
   <!-- Include schematrons from templates with explicit * or ** context (but no representing templates), only those used in scenario template -->
   <!-- OpvragenVaccinatiestatus-payload -->
   <include href="include/2.16.840.1.113883.2.4.6.10.100.181-2012-09-01T000000.sch"/>
</schema>
