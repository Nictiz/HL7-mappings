   ...
   <pattern>
      ...
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 ...
                 see="http://decor.nictiz.nl/pub/jeugdgezondheidszorg/jgz-html-20240426T081156/tmp-2.16.840.1.113883.2.4.6.10.100.13-2012-08-01T000000.html">(VersturenGeldigePartijnummers): In de instance werd het volgende element verwacht: descendant-or-self::hl7:PRMM_IN010043NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]</assert>
      </rule>
   </pattern>
