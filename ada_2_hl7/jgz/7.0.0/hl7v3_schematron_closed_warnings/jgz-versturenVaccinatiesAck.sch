...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Ontvangstbevestiging vaccinaties 327 (2.16.840.1.113883.2.4.3.11.60.100.4.12 2012-06-08T12:42:06)</title>
   ...
   <!-- Include the project schematrons related to scenario versturenVaccinatiesAck -->
   <!-- MCCI_IN000002 -->
   <pattern>
