                            ...
                            <sequelTo>
                                <careProvisionEvent>
                                        ...
                                        <responsibleParty typeCode="RESP">
                                            <xsl:for-each select="groep_g099_periode_geldigheid_verantwoordelijke_jgzorganisatie">
                                                <time xsi:type="IVL_TS">
                                                    ...
                                                    <!-- Item(s) :: einddatum_geldigheid_verantwoordelijke_jgzorganisatie-->
                                                    <xsl:for-each select="einddatum_geldigheid_verantwoordelijke_jgzorganisatie">
                                                        <xsl:call-template name="makeTSValue">
                                                            <xsl:with-param name="xsiType" select="''"/>
                                    ...
                                    <xsl:for-each select="r050_zorggegevens/samenvatting_04">
                                        <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.10009_20120801000000"/>
                                    </xsl:for-each>
                                    ...
                                    <xsl:for-each select="r014_zwangerschap">
                                        <pertinentInformation>
                                            ...
                                            <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.121_20120801000000"/>
                                        </pertinentInformation>
                                    </xsl:for-each>
                                    <!-- Element component3/OntvangenZorg -->
                                    <xsl:for-each select="r035_ontvangen_zorg/groep_g041_ontvangen_zorg">
                                        <component3>
                                            <!-- Template :: A_OntvangenZorg [universal] -->
                                            <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.119_20120801000000"/>
                                        </component3>
                                    </xsl:for-each>
                                    <!-- Element component4/carePlan -->
                                    <xsl:for-each select="r048_zorgplan/groep_g081_zorgplan">
                                        <component4>
                                            <!-- Template :: A_ZorgPlan [universal] -->
                                            <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.120_20120801000000"/>
                                        </component4>
                                    </xsl:for-each>
                                    <!-- Element component5/neoNateData -->
                                    <xsl:for-each select="r016_pasgeborene_en_eerste_levensweken">
                                        <component5>
                                            <!-- Template :: A_NeonateData [universal] -->
                                            <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.118_20120801000000"/>
                                        </component5>
                                    </xsl:for-each>
                                    <!-- Element component6/informationControlActEvent -->
                                    <xsl:for-each select="r010_informatie_over_werkwijze_jgz/groep_g088_afschrift_jgzdossier_verstrekt">
                                        <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.10017_20120801000000"/>
                                    </xsl:for-each>
                                    <!-- Activiteiten -->
