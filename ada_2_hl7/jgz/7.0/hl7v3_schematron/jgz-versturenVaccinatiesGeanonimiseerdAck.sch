...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Ontvangstbevestiging geanonimiseerde vaccinaties 327 (2.16.840.1.113883.2.4.3.11.60.100.4.27 2018-04-26T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario versturenVaccinatiesGeanonimiseerdAck -->
   <!-- MCCI_IN000002 -->
   <pattern>
