...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Ontvangstbevestiging hielprikverzoek (2.16.840.1.113883.2.4.3.11.60.100.4.15 2012-06-08T12:42:06)</title>
   ...
   <!-- Include the project schematrons related to scenario versturenHielprikverzoekAck -->
   <!-- MCCI_IN000002 -->
   <pattern>
