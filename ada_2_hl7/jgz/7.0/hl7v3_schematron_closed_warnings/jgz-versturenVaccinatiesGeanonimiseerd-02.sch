...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Versturen vaccinatie geanonimiseerd 402 (2.16.840.1.113883.2.4.3.11.60.100.4.51 2020-05-27T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario versturenVaccinatiesGeanonimiseerd-02 -->
   <!-- VersturenVaccinatiesGeanonimiseerd -->
   <pattern>
      <title>VersturenVaccinatiesGeanonimiseerd</title>
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:REPC_IN002145NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]"
                 see="http://decor.nictiz.nl/pub/jeugdgezondheidszorg/jgz-html-20230613T223721/tmp-2.16.840.1.113883.2.4.6.10.100.19-2020-05-27T000000.html">(VersturenVaccinatiesGeanonimiseerd): In de instance werd het volgende element verwacht: descendant-or-self::hl7:REPC_IN002145NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.6.10.100.19-2020-05-27T000000.sch"/>
   <include href="include/2.16.840.1.113883.2.4.6.10.100.19-2020-05-27T000000-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.19-2020-05-27T000000"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.102-2012-08-01T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.117-2012-08-01T000000"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.180-2020-05-27T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.41584-2019-11-28T000000"/>
   </phase>
   <phase id="VersturenVaccinatiesGeanonimiseerd">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.19-2020-05-27T000000"/>
   </phase>
   <phase id="VersturenVaccinatiesGeanonimiseerd-closed">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.19-2020-05-27T000000-closed"/>
   </phase>
   ...
   <phase id="R_PatientNL-BRP-identified-confirmable">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.102-2012-08-01T000000"/>
   </phase>
   <phase id="A_Rijksvaccinatie-informational-administered">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.117-2012-08-01T000000"/>
   </phase>
   ...
   <phase id="VersturenVaccinaties-payload-20200527T000000">
      <active pattern="template-2.16.840.1.113883.2.4.6.10.100.180-2020-05-27T000000"/>
   </phase>
   ...
   <include href="include/2.16.840.1.113883.2.4.6.10.100.117-2012-08-01T000000.sch"/>
   ...
   <include href="include/2.16.840.1.113883.2.4.6.10.100.180-2020-05-27T000000.sch"/>
   <!-- obsElement1584 -->
