This is an implementation of converting Kernset 2.3.6 from a relatively simple dataset xml format to a HL7 CareProvision message. It is based on publication 2.3.6.
...
The folder "kernset_aanleverbericht/payload" contains the stylesheet that does the conversion for the payload: "REPC_EX004014NL_Kernset_2.3.6.xsl"
...
The ADA user front-end for Kernset 2.3 can be found here: https://decor.nictiz.nl/art-decor/ada-data/projects/perinatologie-236/views/geboortezorg_index.xhtml
