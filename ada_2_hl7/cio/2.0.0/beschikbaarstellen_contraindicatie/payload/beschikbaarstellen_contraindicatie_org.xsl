...
<xsl:stylesheet xmlns="urn:hl7-org:v3" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" exclude-result-prefixes="#default" xmlns:hl7="urn:hl7-org:v3" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>Mapping xslt for use case 'beschikbaarstellen contraindicatie' in CiO. From ada to hl7.</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:template match="/" name="baseMedicatiegegevens">
        <xsl:param name="in" select="//beschikbaarstellen_contraindicatie" as="element()*"/>
        <xsl:if test="$schematronRef">
            <xsl:processing-instruction name="xml-model">href="file:/C:/SVN/AORTA/trunk/Zorgtoepassing/ContraindicatiesOvergevoeligheden/DECOR/cio-runtime-develop/cio-bci.sch" type="application/xml" schematypens="http://purl.oclc.org/dsdl/schematron" phase="#ALL"</xsl:processing-instruction>
            <xsl:text>
</xsl:text>
            <xsl:text>
</xsl:text>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:call-template name="contraIndicatie_20">
                    ...
                    <xsl:with-param name="mci" select="$in/medicatie_contra_indicatie"/>
                </xsl:call-template>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
    ...
    <xd:doc>
        ...
        <xd:param name="mci">The medication contraindication</xd:param>
    </xd:doc>
        ...
        <organizer xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cda="urn:hl7-org:v3" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:pharm="urn:ihe:pharm:medication" classCode="CLUSTER" moodCode="EVN">
            ...
            <xsl:for-each select="$mci">
                <component typeCode="COMP">
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.3.11.60.26.10.14_20230419">
