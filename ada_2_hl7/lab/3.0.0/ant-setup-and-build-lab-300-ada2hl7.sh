...
echo "setup ..."
ant -Drun-ivy=false -f `dirname $0`/_ant-buildfiles/ant-publish/build-ada2hl7-lab-300.xml setup_lab300 setup convert_ada_2_hl7_300 schemavalidate_hl7_300 schematronvalidate_hl7_300 convert_ada_2_hl7_examples_300 2>&1 | tee `dirname $0`/ant-setup.log
