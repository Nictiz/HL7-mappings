...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="bodyWeightLOINCcode" as="xs:string*">29463-7</xsl:variable>
    
    <xd:doc>
        <xd:desc>Template to convert f:Observation to ADA lichaamslengte.</xd:desc>
    </xd:doc>
    <xsl:template match="f:Observation[f:code/f:coding/f:code/@value=$bodyWeightLOINCcode]" mode="nl-core-BodyWeight">
        <lichaamsgewicht>
            <!-- identificatie -->
    ...
    <xsl:template match="f:effectiveDateTime" mode="nl-core-BodyWeight">
    ...
    <xsl:template match="f:identifier" mode="nl-core-BodyWeight">
    ...
    <xsl:template match="f:valueQuantity" mode="nl-core-BodyWeight">
