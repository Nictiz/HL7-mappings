...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  xmlns:util="urn:hl7:utilities"
	...
	<xsl:template match="/">
		...
		<adaxml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="../ada_schemas/ada_sturen_antwoord_voorstel_medicatieafspraak.xsd">
			...
			<data>
				<sturen_antwoord_voorstel_medicatieafspraak app="mp-mp92" shortName="sturen_antwoord_voorstel_medicatieafspraak" formName="sturen_antwoord_voorstel_medicatieafspraak" transactionRef="2.16.840.1.113883.2.4.3.11.60.20.77.4.373" transactionEffectiveDate="2022-03-02T00:00:00" versionDate="" prefix="mp-" language="nl-NL">
