...
<!--PATTERN Consent-->
   ...
   <axsl:template match="f:Consent" priority="1019" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='adr']))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='adr']))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>ppc-4: IF Scope=adr, there must be a patient</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='treatment']))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='treatment']))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>ppc-5: IF Scope=treatment, there must be a patient</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='patient-privacy']))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='patient-privacy']))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>ppc-2: IF Scope=privacy, there must be a patient</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='research']))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:patient) or not(exists(f:scope/f:coding[f:system/@value='something' and f:code/@value='research']))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>ppc-3: IF Scope=research, there must be a patient</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:Consent/f:text/h:div" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Consent/f:identifier/f:period" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Consent/f:identifier/f:assigner" priority="1016" mode="M4">
   ...
   <axsl:template match="f:Consent/f:patient" priority="1015" mode="M4">
   ...
   <axsl:template match="f:Consent/f:patient/f:identifier/f:period" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Consent/f:patient/f:identifier/f:assigner" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Consent/f:performer" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Consent/f:performer"/>
   ...
   <axsl:template match="f:Consent/f:performer/f:identifier/f:period" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Consent/f:performer/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Consent/f:performer/f:identifier/f:assigner" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Consent/f:performer/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Consent/f:organization" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Consent/f:organization/f:identifier/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Consent/f:organization/f:identifier//f:assigner" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Consent/f:sourceAttachment" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Consent/f:sourceReference" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Consent/f:sourceReference/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Consent/f:sourceReference/f:identifier/f:assigner" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Consent/f:verification/f:verifiedWith" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Consent/f:verification/f:verifiedWith"/>
   ...
   <axsl:template match="f:Consent/f:verification/f:verifiedWith/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Consent/f:verification/f:verifiedWith/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Consent/f:verification/f:verifiedWith/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Consent/f:verification/f:verifiedWith/f:identifier/f:assigner"/>
