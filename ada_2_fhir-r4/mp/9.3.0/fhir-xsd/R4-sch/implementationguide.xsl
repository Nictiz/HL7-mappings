   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">ImplementationGuide</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN ImplementationGuide-->
   ...
   <axsl:template match="f:ImplementationGuide" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide"/>
      ...
      <axsl:choose>
         <axsl:when test="count(for $id in (f:resource/f:fhirVersion) return $id[not(ancestor::f:fhirVersion/@value=$id/@value)])=0"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(for $id in (f:resource/f:fhirVersion) return $id[not(ancestor::f:fhirVersion/@value=$id/@value)])=0">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>ig-2: If a resource has a fhirVersion, it must be oe of the versions defined for the Implementation Guide</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:ImplementationGuide/f:text/h:div" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:text/h:div"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:contact/f:telecom" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:contact/f:telecom/f:period" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueQuantity" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueRange" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueRange/f:low" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueRange/f:high" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueReference" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueReference/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:definition" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:definition"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="count(for $id in (f:resource/f:groupingId) return $id[not(ancestor::f:grouping/@id=$id/@value)])=0"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(for $id in (f:resource/f:groupingId) return $id[not(ancestor::f:grouping/@id=$id/@value)])=0">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>ig-1: If a resource has a groupingId, it must refer to a grouping defined in the Implementation Guide</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:definition/f:resource/f:reference" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:definition/f:resource/f:reference"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:definition/f:resource/f:reference/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:definition/f:resource/f:reference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:definition/f:resource/f:reference/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:definition/f:resource/f:reference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:manifest/f:resource/f:reference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:manifest/f:resource/f:reference"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:manifest/f:resource/f:reference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:manifest/f:resource/f:reference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:manifest/f:resource/f:reference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:manifest/f:resource/f:reference/f:identifier/f:assigner"/>
