   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">MedicinalProductUndesirableEffect</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN MedicinalProductUndesirableEffect-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">MedicinalProductUndesirableEffect</svrl:text>

	<!--RULE -->

   <axsl:template match="f:MedicinalProductUndesirableEffect" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:text/h:div" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:text/h:div"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:subject" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:subject"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:subject/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:subject/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:subject/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:subject/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:population/f:ageRange" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:population/f:ageRange"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:population/f:ageRange/f:low" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:population/f:ageRange/f:low"/>
   ...
   <axsl:template match="f:MedicinalProductUndesirableEffect/f:population/f:ageRange/f:high" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductUndesirableEffect/f:population/f:ageRange/f:high"/>
