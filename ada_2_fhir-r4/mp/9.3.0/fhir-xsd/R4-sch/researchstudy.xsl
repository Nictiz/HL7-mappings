...
<!--PATTERN ResearchStudy-->
   ...
   <axsl:template match="f:ResearchStudy" priority="1028" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:text/h:div" priority="1027" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:identifier/f:period" priority="1026" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:identifier/f:assigner" priority="1025" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:protocol" priority="1024" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:protocol/f:identifier/f:period" priority="1023" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:protocol/f:identifier/f:assigner" priority="1022" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:partOf" priority="1021" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:partOf/f:identifier/f:period" priority="1020" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:partOf/f:identifier/f:assigner" priority="1019" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:contact/f:telecom" priority="1018" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:contact/f:telecom/f:period" priority="1017" mode="M4">
   ...
   <axsl:template match="f:ResearchStudy/f:relatedArtifact/f:document" priority="1016" mode="M4">
