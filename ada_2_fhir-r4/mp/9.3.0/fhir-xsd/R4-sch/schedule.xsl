   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Schedule</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Schedule-->
   ...
   <axsl:template match="f:Schedule" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Schedule/f:text/h:div" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Schedule/f:text/h:div"/>
   ...
   <axsl:template match="f:Schedule/f:identifier/f:period" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Schedule/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Schedule/f:identifier/f:assigner" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Schedule/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Schedule/f:actor" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Schedule/f:actor/f:identifier/f:period" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Schedule/f:actor/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Schedule/f:actor/f:identifier/f:assigner" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Schedule/f:actor/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Schedule/f:planningHorizon" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Schedule/f:planningHorizon"/>
