   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">MedicinalProductInteraction</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN MedicinalProductInteraction-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">MedicinalProductInteraction</svrl:text>

	<!--RULE -->

   <axsl:template match="f:MedicinalProductInteraction" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:text/h:div" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:text/h:div"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:subject" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:subject"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:subject/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:subject/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:subject/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:subject/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:interactant/f:itemReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:interactant/f:itemReference"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:interactant/f:itemReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:interactant/f:itemReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MedicinalProductInteraction/f:interactant/f:itemReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductInteraction/f:interactant/f:itemReference/f:identifier/f:assigner"/>
