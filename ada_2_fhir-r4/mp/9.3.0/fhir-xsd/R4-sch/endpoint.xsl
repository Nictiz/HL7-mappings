   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Endpoint</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Endpoint-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Endpoint</svrl:text>

	<!--RULE -->

   <axsl:template match="f:Endpoint" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint"/>
   ...
   <axsl:template match="f:Endpoint/f:text/h:div" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:text/h:div"/>
   ...
   <axsl:template match="f:Endpoint/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Endpoint/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Endpoint/f:managingOrganization" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:managingOrganization"/>
   ...
   <axsl:template match="f:Endpoint/f:managingOrganization/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:managingOrganization/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Endpoint/f:managingOrganization/f:identifier//f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:managingOrganization/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:Endpoint/f:contact" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:contact"/>
   ...
   <axsl:template match="f:Endpoint/f:contact/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:contact/f:period"/>
   ...
   <axsl:template match="f:Endpoint/f:period" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Endpoint/f:period"/>
