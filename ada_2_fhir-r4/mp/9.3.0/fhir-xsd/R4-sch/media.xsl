...
<!--PATTERN Media-->
   ...
   <axsl:template match="f:Media" priority="1026" mode="M4">
   ...
   <axsl:template match="f:Media/f:text/h:div" priority="1025" mode="M4">
   ...
   <axsl:template match="f:Media/f:identifier/f:period" priority="1024" mode="M4">
   ...
   <axsl:template match="f:Media/f:identifier/f:assigner" priority="1023" mode="M4">
   ...
   <axsl:template match="f:Media/f:basedOn" priority="1022" mode="M4">
   ...
   <axsl:template match="f:Media/f:basedOn/f:identifier/f:period" priority="1021" mode="M4">
   ...
   <axsl:template match="f:Media/f:basedOn/f:identifier/f:assigner" priority="1020" mode="M4">
   ...
   <axsl:template match="f:Media/f:partOf" priority="1019" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:partOf"/>
   ...
   <axsl:template match="f:Media/f:partOf/f:identifier/f:period" priority="1018" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:partOf/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Media/f:partOf/f:identifier/f:assigner" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:partOf/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Media/f:encounter" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:encounter"/>
   ...
   <axsl:template match="f:Media/f:encounter/f:identifier/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:encounter/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Media/f:encounter/f:identifier/f:assigner" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:encounter/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Media/f:createdPeriod" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Media/f:createdPeriod"/>
