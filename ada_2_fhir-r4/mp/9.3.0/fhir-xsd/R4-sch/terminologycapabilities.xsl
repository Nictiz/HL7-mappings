   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">TerminologyCapabilities</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN TerminologyCapabilities-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">TerminologyCapabilities</svrl:text>

	<!--RULE -->

   <axsl:template match="f:TerminologyCapabilities" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities"/>
      ...
      <axsl:choose>
         <axsl:when test="not(f:kind/@value='instance') or exists(f:implementation)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='instance') or exists(f:implementation)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>tcp-3: If kind = instance, implementation must be present and software may be present</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(f:software | f:implementation | f:description) &gt; 0">
               ...
               <svrl:text>tcp-2: A Capability Statement SHALL have at least one of description, software, or implementation element.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="not(f:kind/@value='instance') or (not(exists(f:implementation)) and not(exists(f:software)))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='instance') or (not(exists(f:implementation)) and not(exists(f:software)))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>tcp-5: If kind = requirements, implementation and software must be absent</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test=" not(f:kind/@value='instance') or (not(exists(f:implementation)) and exists(f:software))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='instance') or (not(exists(f:implementation)) and exists(f:software))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>tcp-4: If kind = capability, implementation must be absent, software must be present</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:text/h:div" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:text/h:div"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:contact/f:telecom" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:contact/f:telecom/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueQuantity" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueRange" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueRange/f:low" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueRange/f:high" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueReference" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueReference/f:identifier/f:period" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:TerminologyCapabilities/f:codeSystem" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TerminologyCapabilities/f:codeSystem"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="(count(f:version) &lt;= 1) or not(exists(f:version[not(f:code)]))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(count(f:version) &lt;= 1) or not(exists(f:version[not(f:code)]))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>tcp-1: If there is more than one version, a version code must be defined</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
