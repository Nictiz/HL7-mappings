   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Appointment</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Appointment-->
   ...
   <axsl:template match="f:Appointment" priority="1021" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:cancellationReason)) or f:status/@value=('no-show', 'cancelled')"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:cancellationReason)) or f:status/@value=('no-show', 'cancelled')">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>app-4: Cancelation reason is only used for appointments that have been cancelled, or no-show</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="((exists(f:start) and exists(f:end)) or (f:status/@value='proposed') or (f:status/@value='cancelled') or (f:status/@value='waitlist'))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="((exists(f:start) and exists(f:end)) or (f:status/@value='proposed') or (f:status/@value='cancelled') or (f:status/@value='waitlist'))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="((exists(f:start) and exists(f:end)) or (not(exists(f:start)) and not(exists(f:end))))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="((exists(f:start) and exists(f:end)) or (not(exists(f:start)) and not(exists(f:end))))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:Appointment/f:text/h:div" priority="1020" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:text/h:div"/>
   ...
   <axsl:template match="f:Appointment/f:identifier/f:period" priority="1019" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:identifier/f:assigner" priority="1018" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:reasonReference" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:reasonReference"/>
   ...
   <axsl:template match="f:Appointment/f:reasonReference/f:identifier/f:period" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:reasonReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:reasonReference/f:identifier/f:assigner" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:reasonReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:supportingInformation" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:supportingInformation"/>
   ...
   <axsl:template match="f:Appointment/f:supportingInformation/f:identifier/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:supportingInformation/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:supportingInformation/f:identifier/f:assigner" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:supportingInformation/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:slot" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:slot"/>
   ...
   <axsl:template match="f:Appointment/f:slot/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:slot/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:slot/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:slot/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:basedOn" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:basedOn"/>
   ...
   <axsl:template match="f:Appointment/f:basedOn/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:basedOn/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:basedOn/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:basedOn/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:participant" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:participant"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="(exists(f:type) or exists(f:actor))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(exists(f:type) or exists(f:actor))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>app-1: Either the type or actor on the participant SHALL be specified</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:Appointment/f:participant/f:actor" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:participant/f:actor"/>
   ...
   <axsl:template match="f:Appointment/f:participant/f:actor/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:participant/f:actor/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:participant/f:actor/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:participant/f:actor/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:participant/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:participant/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:requestedPeriod" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:requestedPeriod"/>
