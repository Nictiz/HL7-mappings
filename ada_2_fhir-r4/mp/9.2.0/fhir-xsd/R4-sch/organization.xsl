   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Organization</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Organization-->
   ...
   <axsl:template match="f:Organization" priority="1017" mode="M4">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(f:identifier | f:name) &gt; 0">
               ...
               <svrl:text>org-1: The organization SHALL at least have a name or an identifier, and possibly more than one</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:Organization/f:text/h:div" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:text/h:div"/>
   ...
   <axsl:template match="f:Organization/f:identifier/f:period" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Organization/f:identifier/f:assigner" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Organization/f:telecom" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:telecom"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="count(f:use[@value='home']) = 0"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(f:use[@value='home']) = 0">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:Organization/f:telecom/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:telecom/f:period"/>
   ...
   <axsl:template match="f:Organization/f:address" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:address"/>
   ...
   <axsl:template match="f:Organization/f:address/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:address/f:period"/>
   ...
   <axsl:template match="f:Organization/f:partOf" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:partOf"/>
   ...
   <axsl:template match="f:Organization/f:partOf/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:partOf/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Organization/f:partOf/f:identifier//f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:partOf/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:Organization/f:contact/f:name/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:contact/f:name/f:period"/>
   ...
   <axsl:template match="f:Organization/f:contact/f:telecom" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:Organization/f:contact/f:telecom/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:Organization/f:contact/f:address/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:contact/f:address/f:period"/>
   ...
   <axsl:template match="f:Organization/f:endpoint" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:endpoint"/>
   ...
   <axsl:template match="f:Organization/f:endpoint/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:endpoint/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Organization/f:endpoint/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Organization/f:endpoint/f:identifier/f:assigner"/>
