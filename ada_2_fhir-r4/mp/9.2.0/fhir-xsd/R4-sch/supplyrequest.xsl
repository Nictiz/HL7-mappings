...
<!--PATTERN SupplyRequest-->
   ...
   <axsl:template match="f:SupplyRequest" priority="1033" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:text/h:div" priority="1032" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:identifier/f:period" priority="1031" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:identifier/f:assigner" priority="1030" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:itemReference" priority="1029" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:itemReference"/>
   ...
   <axsl:template match="f:SupplyRequest/f:itemReference/f:identifier/f:period" priority="1028" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:itemReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:SupplyRequest/f:itemReference/f:identifier/f:assigner" priority="1027" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:itemReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:SupplyRequest/f:quantity" priority="1026" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:quantity"/>
   ...
   <axsl:template match="f:SupplyRequest/f:parameter/f:valueQuantity" priority="1025" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:parameter/f:valueQuantity"/>
   ...
   <axsl:template match="f:SupplyRequest/f:parameter/f:valueRange" priority="1024" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:parameter/f:valueRange"/>
   ...
   <axsl:template match="f:SupplyRequest/f:parameter/f:valueRange/f:low" priority="1023" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:parameter/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:SupplyRequest/f:parameter/f:valueRange/f:high" priority="1022" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:parameter/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:SupplyRequest/f:occurrencePeriod" priority="1021" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:occurrenceTiming/f:repeat" priority="1020" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:occurrenceTiming/f:repeat/f:boundsDuration" priority="1019" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:occurrenceTiming/f:repeat/f:boundsRange" priority="1018" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:occurrenceTiming/f:repeat/f:boundsRange/f:low" priority="1017" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:occurrenceTiming/f:repeat/f:boundsRange/f:high" priority="1016" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:occurrenceTiming/f:repeat/f:boundsPeriod" priority="1015" mode="M4">
   ...
   <axsl:template match="f:SupplyRequest/f:requester" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:requester"/>
   ...
   <axsl:template match="f:SupplyRequest/f:requester/f:identifier/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:requester/f:identifier/f:period"/>
   ...
   <axsl:template match="f:SupplyRequest/f:requester/f:identifier/f:assigner" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SupplyRequest/f:requester/f:identifier/f:assigner"/>
