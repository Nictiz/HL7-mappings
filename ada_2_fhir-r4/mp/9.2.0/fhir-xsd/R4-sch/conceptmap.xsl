...
<!--PATTERN ConceptMap-->
   ...
   <axsl:template match="f:ConceptMap" priority="1014" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:text/h:div" priority="1013" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:identifier/f:period" priority="1012" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:identifier/f:assigner" priority="1011" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:contact/f:telecom" priority="1010" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:contact/f:telecom/f:period" priority="1009" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueQuantity" priority="1008" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueRange" priority="1007" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueRange/f:low" priority="1006" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueRange/f:high" priority="1005" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueReference" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueReference/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueReference/f:identifier/f:assigner"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(f:mode/@value != 'other-map') or exists(f:url)">
               ...
               <svrl:text>cmd-3: If the mode is 'other-map', a url must be provided</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
