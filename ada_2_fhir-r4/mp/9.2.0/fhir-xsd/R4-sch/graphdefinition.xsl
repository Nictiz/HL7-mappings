   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">GraphDefinition</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN GraphDefinition-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">GraphDefinition</svrl:text>

	<!--RULE -->

   <axsl:template match="f:GraphDefinition" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition"/>
   ...
   <axsl:template match="f:GraphDefinition/f:text/h:div" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:text/h:div"/>
   ...
   <axsl:template match="f:GraphDefinition/f:contact/f:telecom" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:GraphDefinition/f:contact/f:telecom/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueQuantity" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueRange" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueRange/f:low" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueRange/f:high" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:GraphDefinition/f:useContext/f:valueReference/f:identifier/f:assigner"/>
