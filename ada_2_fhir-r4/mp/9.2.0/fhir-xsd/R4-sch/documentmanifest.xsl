...
<!--PATTERN DocumentManifest-->
   ...
   <axsl:template match="f:DocumentManifest" priority="1022" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:text/h:div" priority="1021" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:masterIdentifier/f:period" priority="1020" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:masterIdentifier/f:assigner" priority="1019" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:identifier/f:period" priority="1018" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:identifier/f:assigner" priority="1017" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:subject" priority="1016" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:subject/f:identifier/f:period" priority="1015" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:subject/f:identifier/f:assigner" priority="1014" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:author" priority="1013" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:author/f:identifier/f:period" priority="1012" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:author/f:identifier/f:assigner" priority="1011" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:recipient" priority="1010" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:recipient/f:identifier/f:period" priority="1009" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:recipient/f:identifier/f:assigner" priority="1008" mode="M4">
   ...
   <axsl:template match="f:DocumentManifest/f:content" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DocumentManifest/f:content"/>
   ...
   <axsl:template match="f:DocumentManifest/f:content/f:identifier/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DocumentManifest/f:content/f:identifier/f:period"/>
   ...
   <axsl:template match="f:DocumentManifest/f:content/f:identifier/f:assigner" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DocumentManifest/f:content/f:identifier/f:assigner"/>
