...
<!--PATTERN FamilyMemberHistory-->
   ...
   <axsl:template match="f:FamilyMemberHistory" priority="1029" mode="M4">
   ...
   <axsl:template match="f:FamilyMemberHistory/f:text/h:div" priority="1028" mode="M4">
   ...
   <axsl:template match="f:FamilyMemberHistory/f:identifier/f:period" priority="1027" mode="M4">
   ...
   <axsl:template match="f:FamilyMemberHistory/f:identifier/f:assigner" priority="1026" mode="M4">
