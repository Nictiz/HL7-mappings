   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">AppointmentResponse</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN AppointmentResponse-->
   ...
   <axsl:template match="f:AppointmentResponse" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse"/>
      ...
      <axsl:choose>
         <axsl:when test="(exists(f:participantType) or exists(f:actor))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(exists(f:participantType) or exists(f:actor))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:AppointmentResponse/f:text/h:div" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:text/h:div"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:appointment" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:appointment"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:appointment/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:appointment/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:appointment/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:appointment/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:actor" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:actor"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:actor/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:actor/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AppointmentResponse/f:actor/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AppointmentResponse/f:actor/f:identifier/f:assigner"/>
