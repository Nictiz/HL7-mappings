...
<!--PATTERN QuestionnaireResponse-->
   ...
   <axsl:template match="f:QuestionnaireResponse" priority="1022" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:text/h:div" priority="1021" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:identifier/f:period" priority="1020" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:identifier/f:assigner" priority="1019" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:basedOn" priority="1018" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:basedOn/f:identifier/f:period" priority="1017" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:basedOn/f:identifier/f:assigner" priority="1016" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:partOf" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:QuestionnaireResponse/f:partOf"/>
   ...
   <axsl:template match="f:QuestionnaireResponse/f:partOf/f:identifier/f:period" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:QuestionnaireResponse/f:partOf/f:identifier/f:period"/>
   ...
   <axsl:template match="f:QuestionnaireResponse/f:partOf/f:identifier/f:assigner" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:QuestionnaireResponse/f:partOf/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:QuestionnaireResponse/f:subject" priority="1012" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:subject/f:identifier/f:period" priority="1011" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:subject/f:identifier/f:assigner" priority="1010" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:encounter" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:QuestionnaireResponse/f:encounter"/>
   ...
   <axsl:template match="f:QuestionnaireResponse/f:encounter/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:QuestionnaireResponse/f:encounter/f:identifier/f:period"/>
   ...
   <axsl:template match="f:QuestionnaireResponse/f:encounter/f:identifier/f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:QuestionnaireResponse/f:encounter/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:QuestionnaireResponse/f:author" priority="1006" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:author/f:identifier/f:period" priority="1005" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:author/f:identifier/f:assigner" priority="1004" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:source" priority="1003" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:source/f:identifier/f:period" priority="1002" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse/f:source/f:identifier/f:assigner" priority="1001" mode="M4">
   ...
   <axsl:template match="f:QuestionnaireResponse//f:item" priority="1000" mode="M4">
