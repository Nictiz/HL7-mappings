   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">DeviceMetric</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN DeviceMetric-->
   ...
   <axsl:template match="f:DeviceMetric" priority="1015" mode="M4">
   ...
   <axsl:template match="f:DeviceMetric/f:text/h:div" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:text/h:div"/>
   ...
   <axsl:template match="f:DeviceMetric/f:identifier/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:identifier/f:period"/>
   ...
   <axsl:template match="f:DeviceMetric/f:identifier/f:assigner" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:DeviceMetric/f:source" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:source"/>
   ...
   <axsl:template match="f:DeviceMetric/f:source/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:source/f:identifier/f:period"/>
   ...
   <axsl:template match="f:DeviceMetric/f:source/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:source/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:DeviceMetric/f:parent" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:parent"/>
   ...
   <axsl:template match="f:DeviceMetric/f:parent/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:parent/f:identifier/f:period"/>
   ...
   <axsl:template match="f:DeviceMetric/f:parent/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:parent/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:measurementPeriod/f:repeat"/>
   ...
   <axsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsDuration" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsDuration"/>
   ...
   <axsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsRange" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsRange"/>
   ...
   <axsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsRange/f:low" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsRange/f:low"/>
   ...
   <axsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsRange/f:high" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsRange/f:high"/>
   ...
   <axsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsPeriod" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsPeriod"/>
