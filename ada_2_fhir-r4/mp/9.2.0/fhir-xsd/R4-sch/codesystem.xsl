   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">CodeSystem</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN CodeSystem-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CodeSystem</svrl:text>

	<!--RULE -->

   <axsl:template match="f:CodeSystem" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem"/>
      ...
      <axsl:choose>
         <axsl:when test="count(distinct-values(descendant::f:concept/f:code/@value))=count(descendant::f:concept)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(distinct-values(descendant::f:concept/f:code/@value))=count(descendant::f:concept)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>csd-1: Within a code system definition, all the codes SHALL be unique</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:CodeSystem/f:text/h:div" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:text/h:div"/>
   ...
   <axsl:template match="f:CodeSystem/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CodeSystem/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:CodeSystem/f:contact/f:telecom" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:CodeSystem/f:contact/f:telecom/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueQuantity" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueRange" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueRange/f:low" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueRange/f:high" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CodeSystem/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CodeSystem/f:useContext/f:valueReference/f:identifier/f:assigner"/>
