...
<!--PATTERN OperationDefinition-->
   ...
   <axsl:template match="f:OperationDefinition" priority="1011" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:text/h:div" priority="1010" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:contact/f:telecom" priority="1009" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:contact/f:telecom/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueQuantity" priority="1007" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueRange" priority="1006" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueRange/f:low" priority="1005" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueRange/f:high" priority="1004" mode="M4">
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueReference" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueReference/f:identifier/f:period" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:OperationDefinition//f:parameter" priority="1000" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:targetProfile)) or ((f:type/@value = 'Reference') or (f:type/@value = 'canonical'))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:targetProfile)) or ((f:type/@value = 'Reference') or (f:type/@value = 'canonical'))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>opd-3: A targetProfile can only be specified for parameters of type Reference or Canonical</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
