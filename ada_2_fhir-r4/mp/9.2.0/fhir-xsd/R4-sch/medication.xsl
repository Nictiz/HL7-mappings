...
<!--PATTERN Medication-->
   ...
   <axsl:template match="f:Medication/f:identifier/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Medication/f:identifier/f:assigner" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Medication/f:manufacturer" priority="1011" mode="M4">
   ...
   <axsl:template match="f:Medication/f:manufacturer/f:identifier/f:period" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Medication/f:manufacturer/f:identifier//f:assigner" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Medication/f:amount" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:amount"/>
   ...
   <axsl:template match="f:Medication/f:amount/f:numerator" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:amount/f:numerator"/>
   ...
   <axsl:template match="f:Medication/f:amount/f:denominator" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:amount/f:denominator"/>
   ...
   <axsl:template match="f:Medication/f:ingredient/f:itemReference" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Medication/f:ingredient/f:itemReference/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Medication/f:ingredient/f:itemReference/f:identifier/f:assigner" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Medication/f:ingredient/f:strength" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:ingredient/f:strength"/>
   ...
   <axsl:template match="f:Medication/f:ingredient/f:strength/f:numerator" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:ingredient/f:strength/f:numerator"/>
   ...
   <axsl:template match="f:Medication/f:ingredient/f:strength/f:denominator" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Medication/f:ingredient/f:strength/f:denominator"/>
