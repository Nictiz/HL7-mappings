...
<!--PATTERN CapabilityStatement-->
   ...
   <axsl:template match="f:CapabilityStatement" priority="1015" mode="M4">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='instance') or (not(exists(f:implementation)) and not(exists(f:software)))">
               ...
               <svrl:text>cpb-16: If kind = requirements, implementation and software must be absent</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='instance') or (not(exists(f:implementation)) and exists(f:software))">
               ...
               <svrl:text>cpb-15: If kind = capability, implementation must be absent, software must be present</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='instance') or exists(f:implementation)">
               ...
               <svrl:text>cpb-14: If kind = instance, implementation must be present and software may be present</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:CapabilityStatement/f:text/h:div" priority="1014" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:contact/f:telecom" priority="1013" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:contact/f:telecom/f:period" priority="1012" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueQuantity" priority="1011" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueRange" priority="1010" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueRange/f:low" priority="1009" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueRange/f:high" priority="1008" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueReference" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CapabilityStatement/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueReference/f:identifier/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CapabilityStatement/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CapabilityStatement/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CapabilityStatement/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:CapabilityStatement/f:implementation/f:custodian" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CapabilityStatement/f:implementation/f:custodian"/>
   ...
   <axsl:template match="f:CapabilityStatement/f:implementation/f:custodian/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CapabilityStatement/f:implementation/f:custodian/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CapabilityStatement/f:implementation/f:custodian/f:identifier//f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CapabilityStatement/f:implementation/f:custodian/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:CapabilityStatement/f:rest" priority="1001" mode="M4">
   ...
   <axsl:template match="f:CapabilityStatement/f:rest/f:resource" priority="1000" mode="M4">
