...
<!--PATTERN VisionPrescription-->
   ...
   <axsl:template match="f:VisionPrescription" priority="1016" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:text/h:div" priority="1015" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:identifier/f:period" priority="1014" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:identifier/f:assigner" priority="1013" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:patient" priority="1012" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:patient/f:identifier/f:period" priority="1011" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:patient/f:identifier/f:assigner" priority="1010" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:encounter" priority="1009" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:encounter/f:identifier/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:encounter/f:identifier/f:assigner" priority="1007" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:prescriber" priority="1006" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:prescriber/f:identifier/f:period" priority="1005" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:prescriber/f:identifier/f:assigner" priority="1004" mode="M4">
   ...
   <axsl:template match="f:VisionPrescription/f:lensSpecification/f:duration" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:VisionPrescription/f:lensSpecification/f:duration"/>
   ...
   <axsl:template match="f:VisionPrescription/f:lensSpecification/f:note/f:authorReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:VisionPrescription/f:lensSpecification/f:note/f:authorReference"/>
   ...
   <axsl:template match="f:VisionPrescription/f:lensSpecification/f:note/f:authorReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:VisionPrescription/f:lensSpecification/f:note/f:authorReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:VisionPrescription/f:lensSpecification/f:note/f:authorReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:VisionPrescription/f:lensSpecification/f:note/f:authorReference/f:identifier/f:assigner"/>
