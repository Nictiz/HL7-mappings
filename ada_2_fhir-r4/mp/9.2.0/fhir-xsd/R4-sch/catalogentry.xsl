   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">CatalogEntry</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN CatalogEntry-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CatalogEntry</svrl:text>

	<!--RULE -->

   <axsl:template match="f:CatalogEntry" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry"/>
   ...
   <axsl:template match="f:CatalogEntry/f:text/h:div" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:text/h:div"/>
   ...
   <axsl:template match="f:CatalogEntry/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CatalogEntry/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:CatalogEntry/f:referencedItem" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:referencedItem"/>
   ...
   <axsl:template match="f:CatalogEntry/f:referencedItem/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:referencedItem/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CatalogEntry/f:referencedItem/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:referencedItem/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:CatalogEntry/f:additionalIdentifier/f:period" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:additionalIdentifier/f:period"/>
   ...
   <axsl:template match="f:CatalogEntry/f:additionalIdentifier/f:assigner" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:additionalIdentifier/f:assigner"/>
   ...
   <axsl:template match="f:CatalogEntry/f:validityPeriod" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:validityPeriod"/>
   ...
   <axsl:template match="f:CatalogEntry/f:relatedEntry/f:item" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:relatedEntry/f:item"/>
   ...
   <axsl:template match="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:period"/>
   ...
   <axsl:template match="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:assigner"/>
