   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Linkage</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Linkage-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Linkage</svrl:text>

	<!--RULE -->

   <axsl:template match="f:Linkage" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage"/>
      ...
      <axsl:choose>
         <axsl:when test="count(f:item)&gt;1"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(f:item)&gt;1">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>lnk-1: Must have at least two items</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:Linkage/f:text/h:div" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:text/h:div"/>
   ...
   <axsl:template match="f:Linkage/f:author" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:author"/>
   ...
   <axsl:template match="f:Linkage/f:author/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:author/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Linkage/f:author/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:author/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Linkage/f:item/f:resource" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:item/f:resource"/>
   ...
   <axsl:template match="f:Linkage/f:item/f:resource/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:item/f:resource/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Linkage/f:item/f:resource/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Linkage/f:item/f:resource/f:identifier/f:assigner"/>
