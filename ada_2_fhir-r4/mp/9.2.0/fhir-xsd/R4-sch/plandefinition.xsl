...
<!--PATTERN PlanDefinition-->
   ...
   <axsl:template match="f:PlanDefinition" priority="1031" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:text/h:div" priority="1030" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:identifier/f:period" priority="1029" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:identifier/f:assigner" priority="1028" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:subjectReference" priority="1027" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:subjectReference"/>
   ...
   <axsl:template match="f:PlanDefinition/f:subjectReference/f:identifier/f:period" priority="1026" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:subjectReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:PlanDefinition/f:subjectReference/f:identifier/f:assigner" priority="1025" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:subjectReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:PlanDefinition/f:contact/f:telecom" priority="1024" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:contact/f:telecom/f:period" priority="1023" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueQuantity" priority="1022" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueRange" priority="1021" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueRange/f:low" priority="1020" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueRange/f:high" priority="1019" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueReference" priority="1018" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueReference/f:identifier/f:period" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:PlanDefinition/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:PlanDefinition/f:effectivePeriod" priority="1015" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:author/f:telecom" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:author/f:telecom"/>
   ...
   <axsl:template match="f:PlanDefinition/f:author/f:telecom/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:author/f:telecom/f:period"/>
   ...
   <axsl:template match="f:PlanDefinition/f:editor/f:telecom" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:editor/f:telecom"/>
   ...
   <axsl:template match="f:PlanDefinition/f:editor/f:telecom/f:period" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:editor/f:telecom/f:period"/>
   ...
   <axsl:template match="f:PlanDefinition/f:reviewer/f:telecom" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:reviewer/f:telecom"/>
   ...
   <axsl:template match="f:PlanDefinition/f:reviewer/f:telecom/f:period" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:reviewer/f:telecom/f:period"/>
   ...
   <axsl:template match="f:PlanDefinition/f:endorser/f:telecom" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:endorser/f:telecom"/>
   ...
   <axsl:template match="f:PlanDefinition/f:endorser/f:telecom/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PlanDefinition/f:endorser/f:telecom/f:period"/>
   ...
   <axsl:template match="f:PlanDefinition/f:relatedArtifact/f:document" priority="1006" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:goal/f:documentation/f:document" priority="1005" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:goal/f:target/f:detailQuantity" priority="1004" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:goal/f:target/f:detailRange" priority="1003" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:goal/f:target/f:detailRange/f:low" priority="1002" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:goal/f:target/f:detailRange/f:high" priority="1001" mode="M4">
   ...
   <axsl:template match="f:PlanDefinition/f:goal/f:target/f:due" priority="1000" mode="M4">
