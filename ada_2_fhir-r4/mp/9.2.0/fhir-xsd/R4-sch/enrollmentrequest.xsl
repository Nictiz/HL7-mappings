...
<!--PATTERN EnrollmentRequest-->
   ...
   <axsl:template match="f:EnrollmentRequest" priority="1015" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:text/h:div" priority="1014" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:identifier/f:period" priority="1013" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:identifier/f:assigner" priority="1012" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:insurer" priority="1011" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:insurer/f:identifier/f:period" priority="1010" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:insurer/f:identifier//f:assigner" priority="1009" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:provider" priority="1008" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:provider/f:identifier/f:period" priority="1007" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:provider/f:identifier/f:assigner" priority="1006" mode="M4">
   ...
   <axsl:template match="f:EnrollmentRequest/f:candidate" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:EnrollmentRequest/f:candidate"/>
   ...
   <axsl:template match="f:EnrollmentRequest/f:candidate/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:EnrollmentRequest/f:candidate/f:identifier/f:period"/>
   ...
   <axsl:template match="f:EnrollmentRequest/f:candidate/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:EnrollmentRequest/f:candidate/f:identifier/f:assigner"/>
