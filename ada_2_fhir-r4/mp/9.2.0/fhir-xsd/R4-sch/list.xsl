   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">List</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN List-->
   ...
   <axsl:template match="f:List" priority="1018" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="(f:mode/@value = 'working') or not(exists(f:entry/f:date))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(f:mode/@value = 'working') or not(exists(f:entry/f:date))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>lst-3: An entry date can only be used if the mode of the list is "working"</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="(f:mode/@value = 'changes') or not(exists(f:entry/f:deleted))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(f:mode/@value = 'changes') or not(exists(f:entry/f:deleted))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:List/f:text/h:div" priority="1017" mode="M4">
   ...
   <axsl:template match="f:List/f:identifier/f:period" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:identifier/f:period"/>
   ...
   <axsl:template match="f:List/f:identifier/f:assigner" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:List/f:subject" priority="1014" mode="M4">
   ...
   <axsl:template match="f:List/f:subject/f:identifier/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:subject/f:identifier/f:period"/>
   ...
   <axsl:template match="f:List/f:subject/f:identifier/f:assigner" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:subject/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:List/f:encounter" priority="1011" mode="M4">
   ...
   <axsl:template match="f:List/f:encounter/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:encounter/f:identifier/f:period"/>
   ...
   <axsl:template match="f:List/f:encounter/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:encounter/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:List/f:source" priority="1008" mode="M4">
   ...
   <axsl:template match="f:List/f:source/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:source/f:identifier/f:period"/>
   ...
   <axsl:template match="f:List/f:source/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:source/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:List/f:note/f:authorReference" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:note/f:authorReference"/>
   ...
   <axsl:template match="f:List/f:note/f:authorReference/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:note/f:authorReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:List/f:note/f:authorReference/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:note/f:authorReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:List/f:entry/f:item" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:entry/f:item"/>
   ...
   <axsl:template match="f:List/f:entry/f:item/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:entry/f:item/f:identifier/f:period"/>
   ...
   <axsl:template match="f:List/f:entry/f:item/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:List/f:entry/f:item/f:identifier/f:assigner"/>
