...
<!--PATTERN ImmunizationRecommendation-->
   ...
   <axsl:template match="f:ImmunizationRecommendation/f:authority" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImmunizationRecommendation/f:authority"/>
   ...
   <axsl:template match="f:ImmunizationRecommendation/f:authority/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImmunizationRecommendation/f:authority/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImmunizationRecommendation/f:authority/f:identifier//f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImmunizationRecommendation/f:authority/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:ImmunizationRecommendation/f:recommendation" priority="1006" mode="M4">
