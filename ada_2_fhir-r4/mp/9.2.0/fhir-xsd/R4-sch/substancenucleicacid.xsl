   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">SubstanceNucleicAcid</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN SubstanceNucleicAcid-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">SubstanceNucleicAcid</svrl:text>

	<!--RULE -->

   <axsl:template match="f:SubstanceNucleicAcid" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid"/>
   ...
   <axsl:template match="f:SubstanceNucleicAcid/f:text/h:div" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid/f:text/h:div"/>
   ...
   <axsl:template match="f:SubstanceNucleicAcid/f:subunit/f:sequenceAttachment" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid/f:subunit/f:sequenceAttachment"/>
   ...
   <axsl:template match="f:SubstanceNucleicAcid/f:subunit/f:linkage/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid/f:subunit/f:linkage/f:identifier/f:period"/>
   ...
   <axsl:template match="f:SubstanceNucleicAcid/f:subunit/f:linkage/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid/f:subunit/f:linkage/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:SubstanceNucleicAcid/f:subunit/f:sugar/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid/f:subunit/f:sugar/f:identifier/f:period"/>
   ...
   <axsl:template match="f:SubstanceNucleicAcid/f:subunit/f:sugar/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceNucleicAcid/f:subunit/f:sugar/f:identifier/f:assigner"/>
