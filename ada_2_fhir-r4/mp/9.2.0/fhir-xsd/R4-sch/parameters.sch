...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Parameters//f:parameter">
      <sch:assert test="count(f:part | f:*[starts-with(local-name(), 'value')] | f:resource) = 1">inv-1: A parameter must have one and only one of (value, resource, part)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
