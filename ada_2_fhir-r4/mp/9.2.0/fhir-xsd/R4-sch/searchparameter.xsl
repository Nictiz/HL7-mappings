   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">SearchParameter</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN SearchParameter-->
   ...
   <axsl:template match="f:SearchParameter" priority="1010" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:xpath)) or exists(f:xpathUsage)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:xpath)) or exists(f:xpathUsage)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:chain)) or (f:type/@value = 'reference')"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:chain)) or (f:type/@value = 'reference')">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>spd-2: Search parameters can only have chain names when the search parameter type is 'reference'</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:SearchParameter/f:text/h:div" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:text/h:div"/>
   ...
   <axsl:template match="f:SearchParameter/f:contact/f:telecom" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:SearchParameter/f:contact/f:telecom/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueQuantity" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueRange" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueRange/f:low" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueRange/f:high" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:SearchParameter/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:useContext/f:valueReference/f:identifier/f:assigner"/>
