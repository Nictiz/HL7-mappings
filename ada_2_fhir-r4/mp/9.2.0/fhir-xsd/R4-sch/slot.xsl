   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Slot</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Slot-->
   ...
   <axsl:template match="f:Slot" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Slot/f:text/h:div" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Slot/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Slot/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Slot/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Slot/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Slot/f:schedule" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Slot/f:schedule/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Slot/f:schedule/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Slot/f:schedule/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Slot/f:schedule/f:identifier/f:assigner"/>
