   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Basic</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Basic-->
   ...
   <axsl:template match="f:Basic" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Basic/f:text/h:div" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:text/h:div"/>
   ...
   <axsl:template match="f:Basic/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Basic/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Basic/f:subject" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Basic/f:subject/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:subject/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Basic/f:subject/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:subject/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Basic/f:author" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Basic/f:author/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:author/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Basic/f:author/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Basic/f:author/f:identifier/f:assigner"/>
