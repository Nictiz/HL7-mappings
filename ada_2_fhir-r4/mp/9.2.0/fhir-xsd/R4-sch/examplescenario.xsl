   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">ExampleScenario</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN ExampleScenario-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">ExampleScenario</svrl:text>

	<!--RULE -->

   <axsl:template match="f:ExampleScenario" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario"/>
   ...
   <axsl:template match="f:ExampleScenario/f:text/h:div" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:text/h:div"/>
   ...
   <axsl:template match="f:ExampleScenario/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ExampleScenario/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ExampleScenario/f:contact/f:telecom" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:ExampleScenario/f:contact/f:telecom/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueQuantity" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueRange" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueRange/f:low" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueRange/f:high" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ExampleScenario/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExampleScenario/f:useContext/f:valueReference/f:identifier/f:assigner"/>
