...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:variable name="profileNameCioReplyProposalContraIndicationBundle">cio-ReplyProposalContraIndication-Bundle</xsl:variable>
    ...
    <xsl:param name="fhirMetadata" as="element()*">
        <xsl:call-template name="buildFhirMetadata">
            <xsl:with-param name="in" select="//(
                sturen_antwoord_voorstel_contra_indicatie/voorstel_gegevens/antwoord_voorstel_contra_indicatie |
                sturen_antwoord_voorstel_contra_indicatie/patient |
                sturen_antwoord_voorstel_contra_indicatie/bouwstenen/zorgverlener |
                sturen_antwoord_voorstel_contra_indicatie/bouwstenen/zorgaanbieder
                )"/>
        </xsl:call-template>
    </xsl:param>
    ...
    <xsl:template match="sturen_antwoord_voorstel_contra_indicatie">
