...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/probleem"/>
    </xsl:template>
    
    <xsl:template match="//probleem_registratie/probleem">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="probleem">
