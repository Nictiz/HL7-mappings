...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/hartfrequentie"/>
    </xsl:template>
    
    <xsl:template match="//hartfrequentie_registratie/hartfrequentie">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="hartfrequentie">
        ...
        <xsl:call-template name="nl-core-HeartRate">
