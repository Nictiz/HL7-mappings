...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/lichaamslengte"/>
    </xsl:template>
    
    <xsl:template match="//lichaamslengte_registratie/lichaamslengte">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="lichaamslengte">
