...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/lichaamsgewicht"/>
    </xsl:template>
    
    <xsl:template match="//lichaamsgewicht_registratie/lichaamsgewicht">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="lichaamsgewicht">
