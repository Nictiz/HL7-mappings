...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/medicatie_contra_indicatie"/>
    </xsl:template>
    
    <xsl:template match="//medicatie_contra_indicatie_registratie/medicatie_contra_indicatie">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="medicatie_contra_indicatie">
