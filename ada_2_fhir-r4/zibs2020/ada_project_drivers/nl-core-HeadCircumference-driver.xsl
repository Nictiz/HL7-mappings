...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/schedelomvang"/>
    </xsl:template>
    
    <xsl:template match="//schedelomvang_registratie/schedelomvang">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="schedelomvang">
        ...
        <xsl:call-template name="nl-core-HeadCircumference">
