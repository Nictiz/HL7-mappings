...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="/nm:bundle">
        <xsl:apply-templates mode="_doTransform" select="$bundle/lichaamstemperatuur"/>
    </xsl:template>
    
    <xsl:template match="//lichaamstemperatuur_registratie/lichaamstemperatuur">
        <xsl:apply-templates mode="_doTransform" select="."/>
    </xsl:template>
    
    <xsl:template mode="_doTransform" match="lichaamstemperatuur">
        ...
        <xsl:call-template name="nl-core-BodyTemperature">
