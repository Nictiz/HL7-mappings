...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir"
    ...
    <xd:doc>
        <xd:desc>Unwrap o2saturatie_registratie element</xd:desc>
    </xd:doc>
    <xsl:template match="o2saturatie_registratie">
        <xsl:apply-templates select="o2saturatie" mode="nl-core-O2Saturation"/>
    </xsl:template>

    <xsl:template match="o2saturatie" name="nl-core-O2Saturation" mode="nl-core-O2Saturation">
        <Observation>
            <id value="nl-core-O2Saturation-01"/>
            <meta>
