...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ada schedelomvang to FHIR Observation conforming to profile nl-core-HeadCircumference</xd:desc>
    </xd:doc>
    
    <xd:doc>
        <xd:desc>Create an nl-core-nl-core-HeadCircumference as a Observation FHIR instance from ada schedelomvang element.</xd:desc>
