...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ada lichaamsgewicht to FHIR Observation conforming to profile http://nictiz.nl/fhir/StructureDefinition/nl-core-BodyWeight</xd:desc>
    </xd:doc>
    
    <xd:doc>
        <xd:desc>Unwrap lichaamsgewicht_registratie element</xd:desc>
    </xd:doc>
    <xsl:template match="lichaamsgewicht_registratie">
        <xsl:apply-templates select="lichaamsgewicht" mode="nl-core-BodyWeight"/>
    </xsl:template>
    
    <xsl:template match="lichaamsgewicht" name="nl-core-BodyWeight" mode="nl-core-BodyWeight">
        <Observation>
            <id value="nl-core-BodyWeight-01"/>
            <meta>
