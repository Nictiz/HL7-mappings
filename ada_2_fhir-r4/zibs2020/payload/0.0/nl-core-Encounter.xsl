...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ada verrichting to FHIR Procedure conforming to profile http://nictiz.nl/fhir/StructureDefinition/nl-core-Encounter</xd:desc>
    </xd:doc>
    ...
    <xsl:template match="contact" name="nl-core-Encounter" mode="nl-core-Encounter">
        <Encounter>
            <meta>
