...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="juridische_situatie_registratie">
        <xsl:apply-templates select="juridische_situatie" mode="nl-core-LegalSituation-LegalStatus"/>
    </xsl:template>
    
    <xsl:template match="juridische_situatie" name="nl-core-LegalSituation-LegalStatus" mode="nl-core-LegalSituation-LegalStatus">
        <Condition>
            <id value="nl-core-LegalSituation-LegalStatus-01"/>
            <meta>
