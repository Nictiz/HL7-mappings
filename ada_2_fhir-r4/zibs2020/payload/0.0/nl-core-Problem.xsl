...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ada probleem to FHIR Procedure conforming to profile http://nictiz.nl/fhir/StructureDefinition/nl-core-Problem</xd:desc>
    </xd:doc>
    ...
    <xsl:template match="probleem" name="nl-core-Problem" mode="nl-core-Problem">
        <Condition>
            <meta>
