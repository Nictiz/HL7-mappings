...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ADA vermogen_tot_zich_wassen to FHIR Observation resource conforming to profile nl-core-AbilityToWashOneself.</xd:desc>
    </xd:doc>
    
    <xsl:variable name="profileNameAbilityToWashOneself">nl-core-AbilityToWashOneself</xsl:variable>
    
    <xd:doc>
        <xd:desc>Creates an nl-core-AbilityToWashOneself instance as an Observation FHIR instance from ADA vermogen_tot_zich_wassen element.</xd:desc>
