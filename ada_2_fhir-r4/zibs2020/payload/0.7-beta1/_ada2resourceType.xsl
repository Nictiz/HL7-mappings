...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--
        ...
        This file is used across all versions of the package, but 0.8.0-beta.1 introduces a breaking change in one of
        the canonicals for zib LaboratoryTestResult (which was introduced in package 0.6-beta2). To keep the proper 
        behaviour in versions of the package between 0.6-beta2 and 0.8.0-beta.1, the static ada2resourceType defined
        here can be used to override the "dynamic" version in 2_fhir_fhir_include.xsl. -->
