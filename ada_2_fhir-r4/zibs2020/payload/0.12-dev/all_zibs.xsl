...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="urn:fhir:stu3:functions" xmlns:nf="http://www.nictiz.nl/functions" xmlns:nm="http://www.nictiz.nl/mappings" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-wounds.WoundCharacteristics.xsl"/>
    <xsl:import href="../0.7-beta1/nl-core-AbilityToDressOneself.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-AbilityToDrink.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-AbilityToEat.xsl"/>
    <xsl:import href="../0.8.0-beta.1/nl-core-AbilityToGroom.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-AbilityToUseToilet.xsl"/>
    ...
    <xsl:import href="../0.10.0-beta.1/nl-core-BarthelADLIndex.xsl"/>
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-BowelFunction.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-Burnwound.xsl" />
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-DevelopmentChild.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-DOSScore.xsl"/>
    ...
    <xsl:import href="../0.10.0-beta.1/nl-core-FeedingPatternInfant.xsl"/>
    <xsl:import href="../0.8.0-beta.1/nl-core-FLACCpainScale.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-FluidBalance.xsl"/>
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-GlasgowComaScale.xsl"/>
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-HearingFunction.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-HeartRate.xsl"/>
    <xsl:import href="../0.8.0-beta.1/nl-core-HelpFromOthers.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-IllnessPerception.xsl"/>
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-MedicalDevice.xsl"/>
    <xsl:import href="../0.8.0-beta.1/nl-core-MedicationContraIndication.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-Mobility.xsl"/>
    <xsl:import href="../0.7-beta1/nl-core-MUSTScore.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-NameInformation.xsl"/>
    <xsl:import href="../0.10.0-beta.1/nl-core-NutritionAdvice.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-O2Saturation.xsl"/>
    <xsl:import href="../0.10.0-beta.1/nl-core-PainScore.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-ParticipationInSociety.xsl"/>
    <xsl:import href="../0.10.0-beta.1/nl-core-Patient.xsl"/>
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-PressureUlcer.xsl"/>
    <xsl:import href="../0.5-beta1/nl-core-Problem.xsl"/>
    <xsl:import href="../0.5-beta1/nl-core-Procedure.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-PulseRate.xsl"/>
    <xsl:import href="../0.8.0-beta.1/nl-core-Refraction.xsl"/>
    <xsl:import href="../0.9.0-beta.1/nl-core-SkinDisorder.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-SNAQ65plusScore.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-SNAQrcScore.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-SNAQScore.xsl"/>
    ...
    <xsl:import href="../0.11.0-beta.1/nl-core-VisualFunction.xsl"/>
    <xsl:import href="../0.11.0-beta.1/nl-core-Wound.xsl" />
