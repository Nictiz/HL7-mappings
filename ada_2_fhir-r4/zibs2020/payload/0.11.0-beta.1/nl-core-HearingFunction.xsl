...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:template match="horen_hulpmiddel/medisch_hulpmiddel[product or product_omschrijving]" name="nl-core-HearingFunction.HearingAid.Product" mode="nl-core-HearingFunction.HearingAid.Product" as="element(f:Device)?">
        <xsl:param name="in" select="." as="element()?"/>
        <xsl:param name="subject" select="patient/*" as="element()?"/>
