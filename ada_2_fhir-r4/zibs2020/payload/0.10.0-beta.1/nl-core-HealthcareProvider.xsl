...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:nm="http://www.nictiz.nl/mappings" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xd:doc>
        ...
        <xd:param name="managingOrganization">ADA element when you want to override the managingOrganization. Defaults to $in. Handy if you don't want duplication of contact/adress data.</xd:param>
    </xd:doc>
    <xsl:template match="zorgaanbieder[not(zorgaanbieder)]" mode="nl-core-HealthcareProvider" name="nl-core-HealthcareProvider" as="element(f:Location)?">
        ...
        <xsl:param name="managingOrganization" as="element()?" select="$in"/>
        ...
        <xsl:for-each select="$in">
            <Location>
                ...
                <!-- 2 name elementen zijn in FHIR niet toegestaan -->
                <xsl:for-each select="(organisatie_locatie/locatie_naam)[1]">
                    <name>
                ...
                <xsl:call-template name="makeReference">
                    <xsl:with-param name="in" select="$managingOrganization"/>
