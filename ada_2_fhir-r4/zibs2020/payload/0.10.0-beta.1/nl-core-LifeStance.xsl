...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ADA levensovertuiging_rc to FHIR Observation resource conforming to profile nl-core-LifeStance.</xd:desc>
    </xd:doc>
    
    <xsl:variable name="profileNameLifeStance">nl-core-LifeStance</xsl:variable>
    
    <xd:doc>
        <xd:desc>Creates an nl-core-LifeStance instance as an Observation FHIR instance from ADA levensovertuiging_rc element.</xd:desc>
        <xd:param name="in">ADA element as input. Defaults to self.</xd:param>
        <xd:param name="subject">Optional ADA instance or ADA reference element for the patient.</xd:param>
    </xd:doc>
    <xsl:template match="levensovertuiging_rc" name="nl-core-LifeStance" mode="nl-core-LifeStance" as="element(f:Observation)?">
