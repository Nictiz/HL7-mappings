...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ADA pijn_score to FHIR Observation resource conforming to profile nl-core-PainScore.</xd:desc>
    </xd:doc>
    
    <xsl:variable name="profileNamePainScore">nl-core-PainScore</xsl:variable>
    
    <xd:doc>
        <xd:desc>Creates an nl-core-PainScore instance as an Observation FHIR instance from ADA pijn_score element.</xd:desc>
