...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:nm="http://www.nictiz.nl/mappings" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="naamgegevens" mode="nl-core-NameInformation" name="nl-core-NameInformation" as="element(f:name)*">
        ...
        <xsl:for-each select="$in">
            ...
            <!-- Strip the unstructured name of spaces -->
            <xsl:variable name="unstructured" as="xs:string?" select="normalize-space(ongestructureerde_naam/@value)"/>
            ...
            <name>
                ...
                <xsl:if test="string-length($unstructured) gt 0">
                    <text>
                        <xsl:attribute name="value">
                            <xsl:value-of select="$unstructured"/>
                        </xsl:attribute>
                    </text>
                </xsl:if>
