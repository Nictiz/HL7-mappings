...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc>
        <xd:desc>Helper template to create an nl-core-LaboratoryTestResult.SpecimenSource instance as Device FHIR instance from ADA laboratorium_uitslag/monster/bron_monster.</xd:desc>
        <xd:param name="in">ADA element as input. Defaults to self.</xd:param>
        <xd:param name="subject">ADA patient element. Has no default</xd:param>
    </xd:doc>
