...
<!--    <xsl:import href="../../fhir/2_fhir_fhir_include.xsl"/>
    ...
    <xd:doc>
        <xd:desc>Converts ada patient to FHIR resource conforming to profile zib-Patient</xd:desc>
    ...
    <xsl:template name="patientReference" match="patient" mode="doPatientReference" as="element()*">
    ...
    <xsl:template name="patientEntry" match="patient" mode="doPatientEntry" as="element(f:entry)">
        ...
        <entry>
            ...
            <resource>
                <xsl:call-template name="zib-Patient">
    ...
    <xsl:template name="zib-Patient" match="patient" mode="doPatientResource" as="element(f:Patient)?">
        ...
        <xsl:for-each select="$in">
            <xsl:variable name="resource">
                <Patient>
                    ...
                    <meta>
                        <profile value="http://fhir.nl/fhir/StructureDefinition/zib-Patient"/>
                    </meta>
