    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9406_20221101091730" match="hl7:substanceAdministration" mode="HandleMTD93">
        ...
        <xsl:for-each select="$in">
            ...
            <medicatietoediening>
                ...
                <!-- prik_plak_locatie -->
                <xsl:variable name="prikPlakLateraliteit" select="hl7:approachSiteCode/hl7:qualifier[hl7:name[@code = '272741003'][@codeSystem = $oidSNOMEDCT]]/hl7:value[@code | @nullFlavor]"/>
                <xsl:choose>
