...
<xsl:stylesheet xmlns:nf="http://www.nictiz.nl/functions" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:pharm="urn:ihe:pharm:medication" xmlns:hl7="urn:hl7-org:v3" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:uuid="http://www.uuid.org" exclude-result-prefixes="#all" version="2.0">
    ...
    <xsl:template match="/">
        ...
        <adaxml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="../ada_schemas/ada_beschikbaarstellen_algemene_bepalingen.xsd">
            <meta status="new" created-by="generated" last-update-by="generated">
                <xsl:attribute name="creation-date" select="current-dateTime()"/>
                <xsl:attribute name="last-update-date" select="current-dateTime()"/>
            </meta>
            <data>
                <xsl:for-each select="//hl7:organizer[hl7:templateId/@root = $oidOrganizerAlgemeneBepaling]">
    ...
    <xsl:template name="BeschikbaarstellenContactverslagen-ADA">
        ...
        <beschikbaarstellen_algemene_bepalingen app="ketenzorg3.0" shortName="beschikbaarstellen_contactverslagen" formName="bundle_of_algemene_bepalingen" transactionRef="2.16.840.1.113883.2.4.3.11.60.66.4.517" transactionEffectiveDate="2018-04-13T00:00:00" versionDate="" prefix="kz-" language="en-US" title="Generated Through Conversion" id="{uuid:get-uuid($in)}">
            ...
            <xsl:variable name="generalMeasurements" select="$in//*[hl7:templateId/@root = $oidAlgemeneBepaling]"/>
            <xsl:for-each select="$generalMeasurements">
                <general_measurement>
        ...
        </beschikbaarstellen_algemene_bepalingen>
