...
=======
                    <sturen_antwoord_voorstel_verstrekkingsverzoek app="mp-mp920" shortName="sturen_antwoord_voorstel_verstrekkingsverzoek" formName="sturen_antwoord_voorstel_verstrekkingsverzoek" transactionRef="2.16.840.1.113883.2.4.3.11.60.20.77.4.274" transactionEffectiveDate="2021-05-05T13:11:50" versionDate="" prefix="mp-" language="nl-NL" title="{$theId}" id="{$theId}">
>>>>>>> origin/master
