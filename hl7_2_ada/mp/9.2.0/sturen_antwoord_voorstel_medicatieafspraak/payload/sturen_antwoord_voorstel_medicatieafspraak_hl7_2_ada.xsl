...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns:nf="http://www.nictiz.nl/functions" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:pharm="urn:ihe:pharm:medication" xmlns:hl7="urn:hl7-org:v3" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:param name="schemaFileString" as="xs:string?">../../hl7_2_ada/mp/9.2.0/sturen_antwoord_voorstel_medicatieafspraak/ada_schemas/sturen_antwoord_voorstel_medicatieafspraak.xsd</xsl:param>
    ...
    <xsl:variable name="gegevensLijst" select="//hl7:organizer[hl7:code[@code='373'][@codeSystem = '2.16.840.1.113883.2.4.3.11.60.20.77.4']] | //hl7:ClinicalDocument"/>
    ...
    <xd:doc>
        <xd:desc>Create adaxml for transaction sturen_antwoord_voorstel_medicatieafspraak</xd:desc>
        ...
        <xsl:variable name="adaXml">
            <adaxml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                <xsl:if test="$outputSchemaRef">
                    <xsl:attribute name="xsi:noNamespaceSchemaLocation">../ada_schemas/ada_sturen_antwoord_voorstel_medicatieafspraak.xsd</xsl:attribute>
                </xsl:if>
                ...
                <data>
                    <sturen_antwoord_voorstel_medicatieafspraak app="mp-mp920" shortName="sturen_antwoord_voorstel_medicatieafspraak" formName="sturen_antwoord_voorstel_medicatieafspraak" transactionRef="2.16.840.1.113883.2.4.3.11.60.20.77.4.373" transactionEffectiveDate="2022-03-02T00:00:00" versionDate="" prefix="mp-" language="nl-NL" title="{$theId}" id="{$theId}">
                        ...
                        <voorstel_gegevens>
                            <xsl:for-each select="$gegevensLijst/hl7:component/hl7:act[hl7:code[@code = '10'][@codeSystem = '2.16.840.1.113883.2.4.3.11.60.20.77.5.3']]">
