            ...
            <adaxml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                ...
                <data>
                    <xsl:for-each select="$medicatiegegevens-lijst">
                        ...
                        <beschikbaarstellen_medicatiegegevens app="mp-mp93" shortName="beschikbaarstellen_medicatiegegevens" formName="medicatiegegevens" transactionRef="2.16.840.1.113883.2.4.3.11.60.20.77.4.374" transactionEffectiveDate="2022-06-30T00:00:00" prefix="mp-" language="nl-NL" title="{$theId}" id="{$theId}">
