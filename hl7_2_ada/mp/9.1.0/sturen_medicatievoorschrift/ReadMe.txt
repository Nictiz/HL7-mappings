...
The folder "sturen_medicatievoorschrift/wrapper" contains the stylesheet that does the conversion to help store some variables for VZVZ wrappers (for LSP) when later converting from ada to a format exchanged on the LSP: sturen_medicatievoorschrift_wrapper.xsl. It outputs an extra xml with the some wrapper instance values exported.
