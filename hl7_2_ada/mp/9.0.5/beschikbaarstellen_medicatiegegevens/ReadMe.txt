This is a preliminary version of converting a HL7v3 message/CDA with a 'medicatieafspraak' to a relatively simple dataset xml format in the transaction 'beschikbaarstellen medicatiegegevens'. It is based on publication 9.0.5 for the HL7v3 medicatieafspraak and on version 9.0.6 for the ADA data format (however: note that 9.0.6 is the same as 9.0.5 for the ADA format).
