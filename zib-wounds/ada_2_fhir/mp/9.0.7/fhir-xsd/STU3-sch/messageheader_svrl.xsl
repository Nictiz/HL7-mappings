...
<!--PATTERN MessageHeader-->
   ...
   <axsl:template match="f:MessageHeader/f:receiver" priority="1022" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MessageHeader/f:receiver"/>
   ...
   <axsl:template match="f:MessageHeader/f:receiver/f:identifier/f:period" priority="1021" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MessageHeader/f:receiver/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MessageHeader/f:receiver/f:identifier/f:assigner" priority="1020" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MessageHeader/f:receiver/f:identifier/f:assigner"/>
