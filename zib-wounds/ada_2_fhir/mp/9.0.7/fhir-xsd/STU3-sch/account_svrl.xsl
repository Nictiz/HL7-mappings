...
<!--PATTERN Account-->
   ...
   <axsl:template match="f:Account" priority="1019" mode="M4">
   ...
   <axsl:template match="f:Account/f:text/h:div" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Account/f:identifier/f:period" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Account/f:identifier/f:assigner" priority="1016" mode="M4">
   ...
   <axsl:template match="f:Account/f:subject" priority="1015" mode="M4">
   ...
   <axsl:template match="f:Account/f:subject/f:identifier/f:period" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Account/f:subject/f:identifier/f:assigner" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Account/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Account/f:period"/>
   ...
   <axsl:template match="f:Account/f:active" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Account/f:active"/>
   ...
   <axsl:template match="f:Account/f:balance" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Account/f:coverage/f:coverage" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Account/f:coverage/f:coverage/f:identifier/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Account/f:coverage/f:coverage/f:identifier/f:assigner" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Account/f:owner" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Account/f:owner/f:identifier/f:period" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Account/f:owner/f:identifier//f:assigner" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Account/f:guarantor/f:party" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Account/f:guarantor/f:party/f:identifier/f:period" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Account/f:guarantor/f:party/f:identifier/f:assigner" priority="1001" mode="M4">
   ...
   <axsl:template match="f:Account/f:guarantor/f:period" priority="1000" mode="M4">
