...
<!--PATTERN ImplementationGuide-->
   ...
   <axsl:template match="f:ImplementationGuide" priority="1016" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:text/h:div" priority="1015" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:contact/f:telecom" priority="1014" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:contact/f:telecom/f:period" priority="1013" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueQuantity" priority="1012" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueRange" priority="1011" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueRange/f:low" priority="1010" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:useContext/f:valueRange/f:high" priority="1009" mode="M4">
   ...
   <axsl:template match="f:ImplementationGuide/f:package/f:resource/f:sourceReference" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:package/f:resource/f:sourceReference"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:package/f:resource/f:sourceReference/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:package/f:resource/f:sourceReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:package/f:resource/f:sourceReference/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:package/f:resource/f:sourceReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:package/f:resource/f:exampleFor" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:package/f:resource/f:exampleFor"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:package/f:resource/f:exampleFor/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:package/f:resource/f:exampleFor/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:package/f:resource/f:exampleFor/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:package/f:resource/f:exampleFor/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:global/f:profile" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:global/f:profile"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:global/f:profile/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:global/f:profile/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ImplementationGuide/f:global/f:profile/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ImplementationGuide/f:global/f:profile/f:identifier/f:assigner"/>
