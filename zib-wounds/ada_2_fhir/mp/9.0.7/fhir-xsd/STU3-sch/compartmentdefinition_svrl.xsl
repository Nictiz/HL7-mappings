...
<!--PATTERN CompartmentDefinition-->
   ...
   <axsl:template match="f:CompartmentDefinition" priority="1007" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:text/h:div" priority="1006" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:contact/f:telecom" priority="1005" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:contact/f:telecom/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:useContext/f:valueQuantity" priority="1003" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:useContext/f:valueRange" priority="1002" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:useContext/f:valueRange/f:low" priority="1001" mode="M4">
   ...
   <axsl:template match="f:CompartmentDefinition/f:useContext/f:valueRange/f:high" priority="1000" mode="M4">
