   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">AuditEvent</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN AuditEvent-->
   ...
   <axsl:template match="f:AuditEvent" priority="1017" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:text/h:div" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:text/h:div"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:reference" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:reference"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:reference/f:identifier/f:period" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:reference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:reference/f:identifier/f:assigner" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:reference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:userId/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:userId/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:userId/f:assigner" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:userId/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:location" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:location"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:location/f:identifier/f:period" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:location/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:location/f:identifier/f:assigner" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:location/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:source/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:source/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:source/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:source/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(exists(f:name)) or not(exists(f:query))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:name)) or not(exists(f:query))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:reference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:reference"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:reference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:reference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:reference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:reference/f:identifier/f:assigner"/>
