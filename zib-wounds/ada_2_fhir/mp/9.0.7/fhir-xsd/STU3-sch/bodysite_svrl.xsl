   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">BodySite</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN BodySite-->
   ...
   <axsl:template match="f:BodySite" priority="1007" mode="M4">
   ...
   <axsl:template match="f:BodySite/f:text/h:div" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodySite/f:text/h:div"/>
   ...
   <axsl:template match="f:BodySite/f:identifier/f:period" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodySite/f:identifier/f:period"/>
   ...
   <axsl:template match="f:BodySite/f:identifier/f:assigner" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodySite/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:BodySite/f:image" priority="1003" mode="M4">
   ...
   <axsl:template match="f:BodySite/f:patient" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodySite/f:patient"/>
   ...
   <axsl:template match="f:BodySite/f:patient/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodySite/f:patient/f:identifier/f:period"/>
   ...
   <axsl:template match="f:BodySite/f:patient/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodySite/f:patient/f:identifier/f:assigner"/>
