...
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>Converts ADA schedelomvang to FHIR Observation resource conforming to profile nl-core-HeadCircumference.</xd:desc>
    </xd:doc>
    
    <xsl:variable name="profileNameHeadCircumference">nl-core-HeadCircumference</xsl:variable>
    
    <xd:doc>
        <xd:desc>Creates an nl-core-HeadCircumference instance as an Observation FHIR instance from ADA schedelomvang element.</xd:desc>
        ...
        <xsl:for-each select="$in">
            <Observation>
                <xsl:call-template name="insertLogicalId">
                    <xsl:with-param name="profile" select="$profileNameHeadCircumference"/>
                </xsl:call-template>
                <meta>
