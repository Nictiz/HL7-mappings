...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:nm="http://www.nictiz.nl/mappings" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xd:doc>
        <xd:desc>Create the FHIR <xd:i>contents</xd:i> of the mp-InstructionsForUse.DosageInstruction datatype profile FHIR instance from ADA InstructionsForUse.</xd:desc>
        <xd:param name="in">The ADA instance to extract the rendered dosage instruction from</xd:param>
                                    ...
                                    <xsl:for-each select="dosering">
                                        ...
                                        <content>
                                            ...
                                            <xsl:for-each select="$route">
                                                <!-- MP-1400: The valueSet Toedieningsweg does _not_ support nullFlavors.
                                                    route is an optional element in FHIR; this will result to no route in the FHIR message -->
