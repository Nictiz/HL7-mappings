...
<!--PATTERN AuditEvent-->
   ...
   <axsl:template match="f:AuditEvent" priority="1015" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:text/h:div" priority="1014" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:period" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:who" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:who"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:who/f:identifier/f:period" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:who/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:who/f:identifier/f:assigner" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:agent/f:who/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:location" priority="1009" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:location/f:identifier/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:agent/f:location/f:identifier/f:assigner" priority="1007" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:source/f:observer" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:source/f:observer"/>
   ...
   <axsl:template match="f:AuditEvent/f:source/f:observer/f:identifier/f:period" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:source/f:observer/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:source/f:observer/f:identifier/f:assigner" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:source/f:observer/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity" priority="1003" mode="M4">
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:what" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:what"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:what/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:what/f:identifier/f:period"/>
   ...
   <axsl:template match="f:AuditEvent/f:entity/f:what/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:AuditEvent/f:entity/f:what/f:identifier/f:assigner"/>
