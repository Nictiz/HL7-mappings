   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">SubstanceProtein</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN SubstanceProtein-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">SubstanceProtein</svrl:text>

	<!--RULE -->

   <axsl:template match="f:SubstanceProtein" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein"/>
   ...
   <axsl:template match="f:SubstanceProtein/f:text/h:div" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein/f:text/h:div"/>
   ...
   <axsl:template match="f:SubstanceProtein/f:subunit/f:sequenceAttachment" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein/f:subunit/f:sequenceAttachment"/>
   ...
   <axsl:template match="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:period"/>
   ...
   <axsl:template match="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:assigner"/>
   ...
   <axsl:template match="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:period"/>
   ...
   <axsl:template match="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:assigner"/>
