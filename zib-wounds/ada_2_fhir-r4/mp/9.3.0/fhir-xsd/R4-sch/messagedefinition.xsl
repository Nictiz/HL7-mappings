...
<!--PATTERN MessageDefinition-->
   ...
   <axsl:template match="f:MessageDefinition" priority="1013" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:text/h:div" priority="1012" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:identifier/f:period" priority="1011" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:identifier/f:assigner" priority="1010" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:contact/f:telecom" priority="1009" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:contact/f:telecom/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueQuantity" priority="1007" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueRange" priority="1006" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueRange/f:low" priority="1005" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueRange/f:high" priority="1004" mode="M4">
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueReference" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MessageDefinition/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueReference/f:identifier/f:period" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MessageDefinition/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MessageDefinition/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MessageDefinition/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:MessageDefinition/f:focus" priority="1000" mode="M4">
