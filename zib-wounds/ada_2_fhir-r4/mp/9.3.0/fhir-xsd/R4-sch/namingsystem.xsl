...
<!--PATTERN NamingSystem-->
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueReference" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:period" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:NamingSystem/f:uniqueId/f:period" priority="1000" mode="M4">
