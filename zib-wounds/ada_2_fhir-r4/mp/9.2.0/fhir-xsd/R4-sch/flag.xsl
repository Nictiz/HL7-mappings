   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Flag</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Flag-->
   ...
   <axsl:template match="f:Flag" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Flag/f:text/h:div" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Flag/f:identifier/f:period" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Flag/f:identifier/f:assigner" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Flag/f:subject" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Flag/f:subject/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:subject/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Flag/f:subject/f:identifier/f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:subject/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Flag/f:period" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Flag/f:encounter" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Flag/f:encounter/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:encounter/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Flag/f:encounter/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:encounter/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Flag/f:author" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Flag/f:author/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:author/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Flag/f:author/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Flag/f:author/f:identifier/f:assigner"/>
