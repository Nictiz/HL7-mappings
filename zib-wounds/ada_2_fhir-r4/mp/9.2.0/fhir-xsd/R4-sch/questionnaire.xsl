...
<!--PATTERN Questionnaire-->
   ...
   <axsl:template match="f:Questionnaire" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:text/h:div" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:identifier/f:period" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:identifier/f:assigner" priority="1011" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:contact/f:telecom" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:contact/f:telecom/f:period" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueQuantity" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueRange" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueRange/f:low" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueRange/f:high" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueReference" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Questionnaire/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueReference/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Questionnaire/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Questionnaire/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Questionnaire/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Questionnaire/f:effectivePeriod" priority="1001" mode="M4">
   ...
   <axsl:template match="f:Questionnaire//f:item" priority="1000" mode="M4">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:type/@value=('group', 'display') and f:*[starts-with(local-name(.), 'initial')])">
               ...
               <svrl:text>que-8: Initial values can't be specified for groups or display items</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="f:type/@value=('choice','open-choice','decimal','integer','date','dateTime','time','string','quantity') or not(f:answerOption or f:answerValueSet)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="f:type/@value=('choice','open-choice','decimal','integer','date','dateTime','time','string','quantity') or not(f:answerOption or f:answerValueSet)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>que-5: Only 'choice' and 'open-choice' items can have answerValueSet</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="not(f:answerValueSet and f:answerOption)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:answerValueSet and f:answerOption)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>que-4: A question cannot have both answerOption and answerValueSet</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="f:repeats/@value='true' or count(f:initial)&lt;=1"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="f:repeats/@value='true' or count(f:initial)&lt;=1">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>que-13: Can only have multiple initial values for repeating items</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="not(f:answerOption) or not(count(f:*[starts-with(local-name(.), 'initial')]))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:answerOption) or not(count(f:*[starts-with(local-name(.), 'initial')]))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>que-11: If one or more answerOption is present, initial[x] must be missing</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:answerOption) or not(count(f:*[starts-with(local-name(.), 'initial')]))">
               ...
               <svrl:text>que-12: If there are more than one enableWhen, enableBehavior must be specified</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
