   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">ValueSet</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN ValueSet-->
   ...
   <axsl:template match="f:ValueSet" priority="1014" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:text/h:div" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:text/h:div"/>
   ...
   <axsl:template match="f:ValueSet/f:identifier/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ValueSet/f:identifier/f:assigner" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ValueSet/f:contact/f:telecom" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:ValueSet/f:contact/f:telecom/f:period" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueQuantity" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueRange" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueRange/f:low" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueRange/f:high" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueReference" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueReference"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueReference/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueReference/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:useContext/f:valueReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ValueSet/f:compose/f:include" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:compose/f:include"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(exists(f:concept) or exists(f:filter)) or exists(f:system)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:concept) or exists(f:filter)) or exists(f:system)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>vsd-2: A value set with concepts or filters SHALL include a system</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:concept)) or not(exists(f:filter))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:concept)) or not(exists(f:filter))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>vsd-3: Cannot have both concept and filter</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="exists(f:valueSet) or exists(f:system)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:valueSet) or exists(f:system)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>vsd-1: A value set include/exclude SHALL have a value set or a system</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:ValueSet/f:expansion//f:contains" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ValueSet/f:expansion//f:contains"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="exists(f:code) or exists(f:display)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:code) or exists(f:display)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="exists(f:code) or (f:abstract/@value = true())"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:code) or (f:abstract/@value = true())">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="exists(f:system) or not(exists(f:code))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:system) or not(exists(f:code))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
