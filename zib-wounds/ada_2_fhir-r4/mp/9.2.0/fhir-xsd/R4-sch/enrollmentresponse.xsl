...
<!--PATTERN EnrollmentResponse-->
   ...
   <axsl:template match="f:EnrollmentResponse" priority="1012" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:text/h:div" priority="1011" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:identifier/f:period" priority="1010" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:identifier/f:assigner" priority="1009" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:request" priority="1008" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:request/f:identifier/f:period" priority="1007" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:request/f:identifier/f:assigner" priority="1006" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:organization" priority="1005" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:organization/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:organization/f:identifier//f:assigner" priority="1003" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:requestProvider" priority="1002" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:requestProvider/f:identifier/f:period" priority="1001" mode="M4">
   ...
   <axsl:template match="f:EnrollmentResponse/f:requestProvider/f:identifier/f:assigner" priority="1000" mode="M4">
