   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">SubstanceSourceMaterial</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN SubstanceSourceMaterial-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">SubstanceSourceMaterial</svrl:text>

	<!--RULE -->

   <axsl:template match="f:SubstanceSourceMaterial" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceSourceMaterial"/>
   ...
   <axsl:template match="f:SubstanceSourceMaterial/f:text/h:div" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceSourceMaterial/f:text/h:div"/>
   ...
   <axsl:template match="f:SubstanceSourceMaterial/f:organismId/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceSourceMaterial/f:organismId/f:period"/>
   ...
   <axsl:template match="f:SubstanceSourceMaterial/f:organismId/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceSourceMaterial/f:organismId/f:assigner"/>
   ...
   <axsl:template match="f:SubstanceSourceMaterial/f:parentSubstanceId/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceSourceMaterial/f:parentSubstanceId/f:period"/>
   ...
   <axsl:template match="f:SubstanceSourceMaterial/f:parentSubstanceId/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SubstanceSourceMaterial/f:parentSubstanceId/f:assigner"/>
