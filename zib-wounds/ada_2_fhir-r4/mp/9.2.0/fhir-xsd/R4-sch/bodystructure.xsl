   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">BodyStructure</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN BodyStructure-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BodyStructure</svrl:text>

	<!--RULE -->

   <axsl:template match="f:BodyStructure" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure"/>
   ...
   <axsl:template match="f:BodyStructure/f:text/h:div" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:text/h:div"/>
   ...
   <axsl:template match="f:BodyStructure/f:identifier/f:period" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:identifier/f:period"/>
   ...
   <axsl:template match="f:BodyStructure/f:identifier/f:assigner" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:BodyStructure/f:image" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:image"/>
   ...
   <axsl:template match="f:BodyStructure/f:patient" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:patient"/>
   ...
   <axsl:template match="f:BodyStructure/f:patient/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:patient/f:identifier/f:period"/>
   ...
   <axsl:template match="f:BodyStructure/f:patient/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:BodyStructure/f:patient/f:identifier/f:assigner"/>
