   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">MedicinalProductManufactured</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN MedicinalProductManufactured-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">MedicinalProductManufactured</svrl:text>

	<!--RULE -->

   <axsl:template match="f:MedicinalProductManufactured" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:text/h:div" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:text/h:div"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:quantity" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:quantity"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:manufacturer" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:manufacturer"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:manufacturer/f:identifier/f:period" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:manufacturer/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:manufacturer/f:identifier//f:assigner" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:manufacturer/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:ingredient" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:ingredient"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:period"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:height" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:height"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:width" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:width"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:depth" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:depth"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:weight" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:weight"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:nominalVolume" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:nominalVolume"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:externalDiameter" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:externalDiameter"/>
   ...
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:image" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:image"/>
