...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:local="urn:fhir:stu3:functions" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xd:doc>
        <xd:desc>Template based on FHIR Profile http://nictiz.nl/fhir/StructureDefinition/mp-MedicationAgreement/ version 0.1 </xd:desc>
    ...
    <xsl:template name="mp-MedicationAgreementEntry-0.1" match="medicatieafspraak | medication_agreement" as="element()" mode="do-mp-MedicationAgreementEntry-0.1">
        ...
        <entry>
            ...
            <resource>
                <xsl:call-template name="mp-MedicationAgreement-0.1">
    ...
    <xd:doc>
        <xd:desc>Template based on FHIR Profile http://nictiz.nl/fhir/StructureDefinition/mp-MedicationAgreement </xd:desc>
        <xd:param name="logicalId">Optional FHIR logical id for the record.</xd:param>
        <xd:param name="in">Node to consider in the creation of a resource</xd:param>
        <xd:param name="adaPatient">Required. ADA patient concept to build a reference to from this resource</xd:param>
        <xd:param name="dateT">Optional. dateT may be given for relative dates, only applicable for test instances</xd:param>
    </xd:doc>
    <xsl:template name="mp-MedicationAgreement-0.1" match="medicatieafspraak[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | medication_agreement[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="do-mp-MedicationAgreementEntry-0.1" as="element()">
            ...
            <xsl:variable name="resource">
                ...
                <MedicationRequest xsl:exclude-result-prefixes="#all">
                    ...
                    <xsl:for-each select="relatie_naar_afspraak_of_gebruik/(identificatie | identificatie_23288 | identificatie_23289)[@value]">
                        <extension url="http://nictiz.nl/fhir/StructureDefinition/mp-MedicationAgreement-BasedOnAgreementOrUse">
                            <valueReference>
                                <identifier>
