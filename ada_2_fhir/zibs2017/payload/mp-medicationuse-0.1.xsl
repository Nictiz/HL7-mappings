...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:local="urn:fhir:stu3:functions" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xd:doc>
        <xd:desc>Template based on FHIR Profile http://nictiz.nl/fhir/StructureDefinition/mp-MedicationUse/ version 0.1</xd:desc>
    ...
    <xsl:template name="mp-MedicationUseEntry-0.1" match="medicatiegebruik[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | medication_use[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" as="element()" mode="do-mp-MedicationUseEntry-0.1">
        ...
        <entry xmlns="http://hl7.org/fhir">
            ...
            <resource>
                <xsl:call-template name="mp-MedicationUse-0.1">
    ...
    <xd:doc>
        <xd:desc>Template based on FHIR Profile http://nictiz.nl/fhir/StructureDefinition/mp-MedicationUse</xd:desc>
    </xd:doc>
    <xd:doc>
        <xd:desc>Template based on FHIR Profile http://nictiz.nl/fhir/StructureDefinition/mp-MedicationUse</xd:desc>
    ...
    <xsl:template name="mp-MedicationUse-0.1" match="medicatiegebruik[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | medication_use[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doMpMedicationUse-0.1" as="element()">
        <xsl:param name="in"/>
        ...
        <xsl:for-each select="$in">
            <xsl:variable name="resource">
                <MedicationStatement>
                    ...
                    <meta>
                        <profile value="http://nictiz.nl/fhir/StructureDefinition/mp-MedicationUse"/>
                    </meta>
                    ...
                    <xsl:for-each select="./auteur[.//@value]">
                        <extension url="http://nictiz.nl/fhir/StructureDefinition/mp-MedicationUse-Author">
                            <xsl:choose>
                    ...
                    <xsl:for-each select="./kopie_indicator[@value]">
                        <xsl:call-template name="ext-mp-Medication-CopyIndicator-0.1"/>
                    </xsl:for-each>
                    
                    <!-- reden_wijzigen_of_stoppen_gebruik -->
                    <xsl:for-each select="./reden_wijzigen_of_stoppen_gebruik[@code]">
                        <extension url="http://nictiz.nl/fhir/StructureDefinition/mp-MedicationUse-ReasonForChangeOrDiscontinuationOfUse">
