...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:local="urn:fhir:stu3:functions" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template name="allergyintoleranceReference" match="allergie_intolerantie[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | allergy_intolerance[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doAllergyIntoleranceReference-3.0">
    ...
    <xsl:template name="allergyIntoleranceEntry-3.0" match="allergie_intolerantie[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | allergy_intolerance[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doAllergyIntoleranceEntry-3.0" as="element(f:entry)">
        ...
        <entry>
            ...
            <resource>
                <xsl:call-template name="zib-AllergyIntolerance-3.0">
    ...
    <xsl:template name="zib-AllergyIntolerance-3.0" match="allergie_intolerantie | allergy_intolerance" as="element()" mode="doZibAllergyIntolerance-3.0">
        ...
        <xsl:for-each select="$in">
            ...
            <xsl:variable name="resource">
                <AllergyIntolerance>
                    ...
                    <xsl:choose>
                        <xsl:when test="veroorzakende_stof | causative_agent">
                        ...
                        <xsl:otherwise>
                            <!-- code is 1..1 in FHIR profile 3.0, but we don't seem to have a value, let's fall back on nullFlavor NI -->
                            <code>
