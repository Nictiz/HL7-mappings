...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="urn:fhir:stu3:functions" xmlns:nf="http://www.nictiz.nl/functions" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-advancedirective-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-alcoholuse-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-bloodpressure-3.0.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-body-height-2.x.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-body-weight-2.x.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-druguse-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-encounter-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-functionalormentalstatus-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-livingsituation-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-medicaldevice-2.2.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-nutritionadvice-2.1.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-payer-2.0.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-problem-3.0.xsl"/>
    <xsl:import href="../../bgz_msz/1.2/beschikbaarstellen/payload/zib-procedure-2.1.xsl"/>
