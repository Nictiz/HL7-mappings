...
<!--PATTERN GraphDefinition-->
   ...
   <axsl:template match="f:GraphDefinition" priority="1007" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:text/h:div" priority="1006" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:contact/f:telecom" priority="1005" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:contact/f:telecom/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueQuantity" priority="1003" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueRange" priority="1002" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueRange/f:low" priority="1001" mode="M4">
   ...
   <axsl:template match="f:GraphDefinition/f:useContext/f:valueRange/f:high" priority="1000" mode="M4">
