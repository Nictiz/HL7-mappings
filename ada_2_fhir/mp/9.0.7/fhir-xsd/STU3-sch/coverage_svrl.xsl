...
<!--PATTERN Coverage-->
   ...
   <axsl:template match="f:Coverage" priority="1019" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:text/h:div" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:identifier/f:period" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:identifier/f:assigner" priority="1016" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:policyHolder" priority="1015" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:policyHolder/f:identifier/f:period" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:policyHolder/f:identifier/f:assigner" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:subscriber" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:subscriber/f:identifier/f:period" priority="1011" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:subscriber/f:identifier/f:assigner" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:beneficiary" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:beneficiary/f:identifier/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:beneficiary/f:identifier/f:assigner" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:period" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:payor" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:payor/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Coverage/f:payor/f:identifier/f:assigner" priority="1003" mode="M4">
