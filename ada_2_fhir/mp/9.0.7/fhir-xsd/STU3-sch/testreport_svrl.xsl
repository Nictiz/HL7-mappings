   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">TestReport</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN TestReport-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">TestReport</svrl:text>

	<!--RULE -->

   <axsl:template match="f:TestReport" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport"/>
   ...
   <axsl:template match="f:TestReport/f:text/h:div" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:text/h:div"/>
   ...
   <axsl:template match="f:TestReport/f:identifier/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:identifier/f:period"/>
   ...
   <axsl:template match="f:TestReport/f:identifier/f:assigner" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:TestReport/f:testScript" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:testScript"/>
   ...
   <axsl:template match="f:TestReport/f:testScript/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:testScript/f:identifier/f:period"/>
   ...
   <axsl:template match="f:TestReport/f:testScript/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:testScript/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:TestReport/f:setup/f:action" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:setup/f:action"/>
   ...
   <axsl:template match="f:TestReport/f:test/f:action" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:TestReport/f:test/f:action"/>
