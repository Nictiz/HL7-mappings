...
<!--PATTERN Goal-->
   ...
   <axsl:template match="f:Goal" priority="1024" mode="M4">
   ...
   <axsl:template match="f:Goal/f:text/h:div" priority="1023" mode="M4">
   ...
   <axsl:template match="f:Goal/f:identifier/f:period" priority="1022" mode="M4">
   ...
   <axsl:template match="f:Goal/f:identifier/f:assigner" priority="1021" mode="M4">
   ...
   <axsl:template match="f:Goal/f:subject" priority="1020" mode="M4">
   ...
   <axsl:template match="f:Goal/f:subject/f:identifier/f:period" priority="1019" mode="M4">
   ...
   <axsl:template match="f:Goal/f:subject/f:identifier/f:assigner" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Goal/f:target" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Goal/f:target/f:detailQuantity" priority="1016" mode="M4">
   ...
   <axsl:template match="f:Goal/f:target/f:detailRange" priority="1015" mode="M4">
   ...
   <axsl:template match="f:Goal/f:target/f:detailRange/f:low" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Goal/f:target/f:detailRange/f:high" priority="1013" mode="M4">
