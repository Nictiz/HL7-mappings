...
<!--PATTERN StructureDefinition-->
   ...
   <axsl:template match="f:StructureDefinition" priority="1032" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="f:kind/@value = 'logical' or count(f:differential/f:element/f:type/f:code[@value and not(matches(string(@value), '^[a-zA-Z0-9]+$'))]|f:snapshot/f:element/f:type/f:code[@value and not(matches(string(@value), '^[a-zA-Z0-9]+$'))]) =0"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="f:kind/@value = 'logical' or count(f:differential/f:element/f:type/f:code[@value and not(matches(string(@value), '^[a-zA-Z0-9]+$'))]|f:snapshot/f:element/f:type/f:code[@value and not(matches(string(@value), '^[a-zA-Z0-9]+$'))]) =0">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>sdf-19: Custom types can only be used in logical models</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="f:baseDefinition or not(exists(f:snapshot/f:element/f:base) or exists(f:differential/f:element/f:base))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="f:baseDefinition or not(exists(f:snapshot/f:element/f:base) or exists(f:differential/f:element/f:base))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:snapshot)) or (f:type/@value = f:snapshot/f:element[1]/f:path/@value)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:snapshot)) or (f:type/@value = f:snapshot/f:element[1]/f:path/@value)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="(f:derivation/@value = 'constraint') or (f:kind/@value = 'logical') or (f:url/@value=concat('http://hl7.org/fhir/StructureDefinition/', f:id/@value))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(f:derivation/@value = 'constraint') or (f:kind/@value = 'logical') or (f:url/@value=concat('http://hl7.org/fhir/StructureDefinition/', f:id/@value))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(f:type/@value = 'extension') or (f:derivation/@value = 'specialization') or (exists(f:context) and exists(f:contextType))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:type/@value = 'extension') or (f:derivation/@value = 'specialization') or (exists(f:context) and exists(f:contextType))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:StructureDefinition/f:text/h:div" priority="1031" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:identifier/f:period" priority="1030" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:identifier/f:assigner" priority="1029" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:contact/f:telecom" priority="1028" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:contact/f:telecom/f:period" priority="1027" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:useContext/f:valueQuantity" priority="1026" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:useContext/f:valueRange" priority="1025" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:useContext/f:valueRange/f:low" priority="1024" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:useContext/f:valueRange/f:high" priority="1023" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:mapping" priority="1022" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot" priority="1021" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:snapshot"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(f:element[1]/f:type)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:element[1]/f:type)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>sdf-15: The first element in a snapshot has no type</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="f:element[1]/f:path/@value=parent::f:StructureDefinition/f:type/@value and count(f:element[position()!=1])=count(f:element[position()!=1][starts-with(f:path/@value, concat(ancestor::f:StructureDefinition/f:type/@value, '.'))])">
               ...
               <svrl:text>sdf-8: In any snapshot, all the elements must be in the specified type</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element" priority="1020" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:binding)) or (count(f:type/f:code) = 0) or  f:type/f:code/@value=('code','Coding','CodeableConcept','Quantity','Extension', 'string', 'uri')"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:binding)) or (count(f:type/f:code) = 0) or f:type/f:code/@value=('code','Coding','CodeableConcept','Quantity','Extension', 'string', 'uri')">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(for $type in f:type return $type/preceding-sibling::f:type[f:code/@value=$type/f:code/@value and f:profile/@value = $type/f:profile/@value]))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(for $type in f:type return $type/preceding-sibling::f:type[f:code/@value=$type/f:code/@value and f:profile/@value = $type/f:profile/@value]))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:slicing" priority="1019" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:max" priority="1018" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:type" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:snapshot/f:element/f:type"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(exists(f:aggregation)) or exists(f:code[@value = 'Reference'])"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:aggregation)) or exists(f:code[@value = 'Reference'])">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:minValueQuantity" priority="1016" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:maxValueQuantity" priority="1015" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:binding" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:snapshot/f:element/f:binding"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="(exists(f:valueSetUri) or exists(f:valueSetReference)) or exists(f:description)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(exists(f:valueSetUri) or exists(f:valueSetReference)) or exists(f:description)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:valueSetUri)) or (starts-with(string(f:valueSetUri/@value), 'http:') or starts-with(string(f:valueSetUri/@value), 'https:') or starts-with(string(f:valueSetUri/@value), 'urn:'))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:valueSetUri)) or (starts-with(string(f:valueSetUri/@value), 'http:') or starts-with(string(f:valueSetUri/@value), 'https:') or starts-with(string(f:valueSetUri/@value), 'urn:'))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>eld-12: ValueSet as a URI SHALL start with http:// or https:// or urn:</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:binding/f:valueSetReference" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:snapshot/f:element/f:binding/f:valueSetReference"/>
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:binding/f:valueSetReference/f:identifier/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:snapshot/f:element/f:binding/f:valueSetReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:StructureDefinition/f:snapshot/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:snapshot/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:StructureDefinition/f:differential" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:differential"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(f:element[1][not(contains(f:path/@value, '.'))]/f:type)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:element[1][not(contains(f:path/@value, '.'))]/f:type)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>sdf-15a: If the first element in a differential has no "." in the path, it has no type</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(f:element)=count(f:element[f:path/@value=ancestor::f:StructureDefinition/f:type/@value or starts-with(f:path/@value, concat(ancestor::f:StructureDefinition/f:type/@value, '.'))])">
               ...
               <svrl:text>sdf-8a: In any differential, all the elements must be in the specified type</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element" priority="1009" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:slicing" priority="1008" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:max" priority="1007" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:type" priority="1006" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:minValueQuantity" priority="1005" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:maxValueQuantity" priority="1004" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:binding" priority="1003" mode="M4">
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:binding/f:valueSetReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:differential/f:element/f:binding/f:valueSetReference"/>
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:binding/f:valueSetReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:differential/f:element/f:binding/f:valueSetReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:StructureDefinition/f:differential/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureDefinition/f:differential/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner"/>
