...
<!--PATTERN Appointment-->
   ...
   <axsl:template match="f:Appointment" priority="1020" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="((exists(f:start) and exists(f:end)) or (f:status/@value='proposed') or (f:status/@value='cancelled'))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="((exists(f:start) and exists(f:end)) or (f:status/@value='proposed') or (f:status/@value='cancelled'))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:Appointment/f:text/h:div" priority="1019" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:identifier/f:period" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:identifier/f:assigner" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:indication" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:indication"/>
   ...
   <axsl:template match="f:Appointment/f:indication/f:identifier/f:period" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:indication/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:indication/f:identifier/f:assigner" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:indication/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:supportingInformation" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:supportingInformation/f:identifier/f:period" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:supportingInformation/f:identifier/f:assigner" priority="1011" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:slot" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:slot/f:identifier/f:period" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:slot/f:identifier/f:assigner" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:incomingReferral" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:incomingReferral"/>
   ...
   <axsl:template match="f:Appointment/f:incomingReferral/f:identifier/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:incomingReferral/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Appointment/f:incomingReferral/f:identifier/f:assigner" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Appointment/f:incomingReferral/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Appointment/f:participant" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:participant/f:actor" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:participant/f:actor/f:identifier/f:period" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Appointment/f:participant/f:actor/f:identifier/f:assigner" priority="1001" mode="M4">
