...
<!--PATTERN Observation-->
   ...
   <axsl:template match="f:Observation" priority="1051" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:*[starts-with(local-name(.), 'value')])) or not(count(for $coding in f:code/f:coding return parent::*/f:component/f:code/f:coding[f:code/@value=$coding/f:code/@value and f:system/@value=$coding/f:system/@value])=0)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:*[starts-with(local-name(.), 'value')])) or not(count(for $coding in f:code/f:coding return parent::*/f:component/f:code/f:coding[f:code/@value=$coding/f:code/@value and f:system/@value=$coding/f:system/@value])=0)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>obs-7: If code is the same as a component code then the value element associated with the code SHALL NOT be present</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:Observation/f:text/h:div" priority="1050" mode="M4">
   ...
   <axsl:template match="f:Observation/f:identifier/f:period" priority="1049" mode="M4">
   ...
   <axsl:template match="f:Observation/f:identifier/f:assigner" priority="1048" mode="M4">
   ...
   <axsl:template match="f:Observation/f:basedOn" priority="1047" mode="M4">
   ...
   <axsl:template match="f:Observation/f:basedOn/f:identifier/f:period" priority="1046" mode="M4">
   ...
   <axsl:template match="f:Observation/f:basedOn/f:identifier/f:assigner" priority="1045" mode="M4">
   ...
   <axsl:template match="f:Observation/f:subject" priority="1044" mode="M4">
   ...
   <axsl:template match="f:Observation/f:subject/f:identifier/f:period" priority="1043" mode="M4">
   ...
   <axsl:template match="f:Observation/f:subject/f:identifier/f:assigner" priority="1042" mode="M4">
   ...
   <axsl:template match="f:Observation/f:context" priority="1041" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:context"/>
   ...
   <axsl:template match="f:Observation/f:context/f:identifier/f:period" priority="1040" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:context/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Observation/f:context/f:identifier/f:assigner" priority="1039" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:context/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Observation/f:effectivePeriod" priority="1038" mode="M4">
   ...
   <axsl:template match="f:Observation/f:performer" priority="1037" mode="M4">
   ...
   <axsl:template match="f:Observation/f:performer/f:identifier/f:period" priority="1036" mode="M4">
   ...
   <axsl:template match="f:Observation/f:performer/f:identifier/f:assigner" priority="1035" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueQuantity" priority="1034" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueRange" priority="1033" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueRange/f:low" priority="1032" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueRange/f:high" priority="1031" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueRatio" priority="1030" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueRatio/f:numerator" priority="1029" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueRatio/f:denominator" priority="1028" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueSampledData/f:origin" priority="1027" mode="M4">
   ...
   <axsl:template match="f:Observation/f:valueAttachment" priority="1026" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:valueAttachment"/>
   ...
   <axsl:template match="f:Observation/f:valuePeriod" priority="1025" mode="M4">
   ...
   <axsl:template match="f:Observation/f:specimen" priority="1024" mode="M4">
   ...
   <axsl:template match="f:Observation/f:specimen/f:identifier/f:period" priority="1023" mode="M4">
   ...
   <axsl:template match="f:Observation/f:specimen/f:identifier/f:assigner" priority="1022" mode="M4">
   ...
   <axsl:template match="f:Observation/f:device" priority="1021" mode="M4">
   ...
   <axsl:template match="f:Observation/f:device/f:identifier/f:period" priority="1020" mode="M4">
   ...
   <axsl:template match="f:Observation/f:device/f:identifier/f:assigner" priority="1019" mode="M4">
   ...
   <axsl:template match="f:Observation/f:referenceRange" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Observation/f:referenceRange/f:low" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Observation/f:referenceRange/f:high" priority="1016" mode="M4">
   ...
   <axsl:template match="f:Observation/f:referenceRange/f:age" priority="1015" mode="M4">
   ...
   <axsl:template match="f:Observation/f:referenceRange/f:age/f:low" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Observation/f:referenceRange/f:age/f:high" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Observation/f:related/f:target" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:related/f:target"/>
   ...
   <axsl:template match="f:Observation/f:related/f:target/f:identifier/f:period" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:related/f:target/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Observation/f:related/f:target/f:identifier/f:assigner" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:related/f:target/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Observation/f:component/f:valueQuantity" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueRange" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueRange/f:low" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueRange/f:high" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueRatio" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueRatio/f:numerator" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueRatio/f:denominator" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueSampledData/f:origin" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Observation/f:component/f:valueAttachment" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Observation/f:component/f:valueAttachment"/>
