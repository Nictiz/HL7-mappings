   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">NamingSystem</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN NamingSystem-->
   ...
   <axsl:template match="f:NamingSystem" priority="1011" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="not(f:kind/@value='root' and f:uniqueId/f:type/@value='uuid')"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:kind/@value='root' and f:uniqueId/f:type/@value='uuid')">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>nsd-1: Root systems cannot have uuid identifiers</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="not(f:replacedBy) or f:status/@value='retired'"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:replacedBy) or f:status/@value='retired'">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(for $type in distinct-values(f:uniqueId/f:type/@value) return if (count(f:uniqueId[f:type/@value=$type and f:preferred/@value=true()])&gt;1) then $type else ()))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(for $type in distinct-values(f:uniqueId/f:type/@value) return if (count(f:uniqueId[f:type/@value=$type and f:preferred/@value=true()])&gt;1) then $type else ()))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:NamingSystem/f:text/h:div" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:text/h:div"/>
   ...
   <axsl:template match="f:NamingSystem/f:contact/f:telecom" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:NamingSystem/f:contact/f:telecom/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueQuantity" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueRange" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueRange/f:low" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:NamingSystem/f:useContext/f:valueRange/f:high" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:NamingSystem/f:uniqueId/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:uniqueId/f:period"/>
   ...
   <axsl:template match="f:NamingSystem/f:replacedBy" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:replacedBy"/>
   ...
   <axsl:template match="f:NamingSystem/f:replacedBy/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:replacedBy/f:identifier/f:period"/>
   ...
   <axsl:template match="f:NamingSystem/f:replacedBy/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:NamingSystem/f:replacedBy/f:identifier/f:assigner"/>
