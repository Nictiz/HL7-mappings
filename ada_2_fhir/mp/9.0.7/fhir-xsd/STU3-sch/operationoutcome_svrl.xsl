   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">OperationOutcome</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN OperationOutcome-->
   ...
   <axsl:template match="f:OperationOutcome" priority="1001" mode="M4">
   ...
   <axsl:template match="f:OperationOutcome/f:text/h:div" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationOutcome/f:text/h:div"/>
