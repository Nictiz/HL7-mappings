   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">ConceptMap</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN ConceptMap-->
   ...
   <axsl:template match="f:ConceptMap" priority="1017" mode="M4">
   ...
   <axsl:template match="f:ConceptMap/f:text/h:div" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:text/h:div"/>
   ...
   <axsl:template match="f:ConceptMap/f:identifier/f:period" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ConceptMap/f:identifier/f:assigner" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ConceptMap/f:contact/f:telecom" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:ConceptMap/f:contact/f:telecom/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueQuantity" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueRange" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueRange/f:low" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:ConceptMap/f:useContext/f:valueRange/f:high" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:ConceptMap/f:sourceReference" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:sourceReference"/>
   ...
   <axsl:template match="f:ConceptMap/f:sourceReference/f:identifier/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:sourceReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ConceptMap/f:sourceReference/f:identifier/f:assigner" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:sourceReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ConceptMap/f:targetReference" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:targetReference"/>
   ...
   <axsl:template match="f:ConceptMap/f:targetReference/f:identifier/f:period" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:targetReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ConceptMap/f:targetReference/f:identifier/f:assigner" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:targetReference/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ConceptMap/f:group/f:element/f:target" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:group/f:element/f:target"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="exists(f:comment) or not(exists(f:equivalence)) or ((f:equivalence/@value != 'narrower') and (f:equivalence/@value != 'inexact'))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:comment) or not(exists(f:equivalence)) or ((f:equivalence/@value != 'narrower') and (f:equivalence/@value != 'inexact'))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:ConceptMap/f:group/f:unmapped" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ConceptMap/f:group/f:unmapped"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="(f:mode/@value != 'other-map') or exists(f:url)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(f:mode/@value != 'other-map') or exists(f:url)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>cmd-3: If the mode is 'other-map', a code must be provided</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="(f:mode/@value != 'fixed') or exists(f:code)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(f:mode/@value != 'fixed') or exists(f:code)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>cmd-2: If the mode is 'fixed', a code must be provided</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
