...
<!--PATTERN PaymentNotice-->
   ...
   <axsl:template match="f:PaymentNotice" priority="1018" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:text/h:div" priority="1017" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:identifier/f:period" priority="1016" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:identifier/f:assigner" priority="1015" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:request" priority="1014" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:request/f:identifier/f:period" priority="1013" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:request/f:identifier/f:assigner" priority="1012" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:response" priority="1011" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:response/f:identifier/f:period" priority="1010" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:response/f:identifier/f:assigner" priority="1009" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:target" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PaymentNotice/f:target"/>
   ...
   <axsl:template match="f:PaymentNotice/f:target/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PaymentNotice/f:target/f:identifier/f:period"/>
   ...
   <axsl:template match="f:PaymentNotice/f:target/f:identifier//f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PaymentNotice/f:target/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:PaymentNotice/f:provider" priority="1005" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:provider/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:provider/f:identifier/f:assigner" priority="1003" mode="M4">
   ...
   <axsl:template match="f:PaymentNotice/f:organization" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PaymentNotice/f:organization"/>
   ...
   <axsl:template match="f:PaymentNotice/f:organization/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PaymentNotice/f:organization/f:identifier/f:period"/>
   ...
   <axsl:template match="f:PaymentNotice/f:organization/f:identifier//f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:PaymentNotice/f:organization/f:identifier//f:assigner"/>
