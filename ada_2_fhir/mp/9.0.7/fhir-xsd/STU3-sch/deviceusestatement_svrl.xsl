...
<!--PATTERN DeviceUseStatement-->
   ...
   <axsl:template match="f:DeviceUseStatement" priority="1023" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:text/h:div" priority="1022" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:identifier/f:period" priority="1021" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:identifier/f:assigner" priority="1020" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:subject" priority="1019" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:subject/f:identifier/f:period" priority="1018" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:subject/f:identifier/f:assigner" priority="1017" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:whenUsed" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DeviceUseStatement/f:whenUsed"/>
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat" priority="1015" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsDuration" priority="1014" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsRange" priority="1013" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsRange/f:low" priority="1012" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsRange/f:high" priority="1011" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsPeriod" priority="1010" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:timingPeriod" priority="1009" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:source" priority="1008" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:source/f:identifier/f:period" priority="1007" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:source/f:identifier/f:assigner" priority="1006" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:device" priority="1005" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:device/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:DeviceUseStatement/f:device/f:identifier/f:assigner" priority="1003" mode="M4">
