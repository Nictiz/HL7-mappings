...
<!--PATTERN Library-->
   ...
   <axsl:template match="f:Library" priority="1025" mode="M4">
   ...
   <axsl:template match="f:Library/f:text/h:div" priority="1024" mode="M4">
   ...
   <axsl:template match="f:Library/f:identifier/f:period" priority="1023" mode="M4">
   ...
   <axsl:template match="f:Library/f:identifier/f:assigner" priority="1022" mode="M4">
   ...
   <axsl:template match="f:Library/f:effectivePeriod" priority="1021" mode="M4">
   ...
   <axsl:template match="f:Library/f:useContext/f:valueQuantity" priority="1020" mode="M4">
   ...
   <axsl:template match="f:Library/f:useContext/f:valueRange" priority="1019" mode="M4">
   ...
   <axsl:template match="f:Library/f:useContext/f:valueRange/f:low" priority="1018" mode="M4">
   ...
   <axsl:template match="f:Library/f:useContext/f:valueRange/f:high" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Library/f:contributor/f:contact/f:telecom" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:contributor/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:Library/f:contributor/f:contact/f:telecom/f:period" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:contributor/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:Library/f:contact/f:telecom" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Library/f:contact/f:telecom/f:period" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Library/f:relatedArtifact/f:document" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Library/f:relatedArtifact/f:resource" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:relatedArtifact/f:resource"/>
   ...
   <axsl:template match="f:Library/f:relatedArtifact/f:resource/f:identifier/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:relatedArtifact/f:resource/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Library/f:relatedArtifact/f:resource/f:identifier/f:assigner" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:relatedArtifact/f:resource/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Library/f:parameter/f:profile" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:parameter/f:profile"/>
   ...
   <axsl:template match="f:Library/f:parameter/f:profile/f:identifier/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:parameter/f:profile/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Library/f:parameter/f:profile/f:identifier/f:assigner" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:parameter/f:profile/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Library/f:dataRequirement/f:codeFilter/f:valueSetReference" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:dataRequirement/f:codeFilter/f:valueSetReference"/>
   ...
   <axsl:template match="f:Library/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Library/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Library/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:assigner"/>
