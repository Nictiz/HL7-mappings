...
<!--PATTERN Device-->
   ...
   <axsl:template match="f:Device" priority="1017" mode="M4">
   ...
   <axsl:template match="f:Device/f:text/h:div" priority="1016" mode="M4">
   ...
   <axsl:template match="f:Device/f:identifier/f:period" priority="1015" mode="M4">
   ...
   <axsl:template match="f:Device/f:identifier/f:assigner" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Device/f:patient" priority="1013" mode="M4">
   ...
   <axsl:template match="f:Device/f:patient/f:identifier/f:period" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Device/f:patient/f:identifier/f:assigner" priority="1011" mode="M4">
   ...
   <axsl:template match="f:Device/f:owner" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Device/f:owner/f:identifier/f:period" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Device/f:owner/f:identifier//f:assigner" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Device/f:contact" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Device/f:contact/f:period" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Device/f:location" priority="1005" mode="M4">
   ...
   <axsl:template match="f:Device/f:location/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:Device/f:location/f:identifier/f:assigner" priority="1003" mode="M4">
   ...
   <axsl:template match="f:Device/f:note/f:authorReference" priority="1002" mode="M4">
   ...
   <axsl:template match="f:Device/f:note/f:authorReference/f:identifier/f:period" priority="1001" mode="M4">
   ...
   <axsl:template match="f:Device/f:note/f:authorReference/f:identifier/f:assigner" priority="1000" mode="M4">
