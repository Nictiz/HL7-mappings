...
<!--PATTERN StructureMap-->
   ...
   <axsl:template match="f:StructureMap" priority="1010" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:text/h:div" priority="1009" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:identifier/f:period" priority="1008" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:identifier/f:assigner" priority="1007" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:contact/f:telecom" priority="1006" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:contact/f:telecom/f:period" priority="1005" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:useContext/f:valueQuantity" priority="1004" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:useContext/f:valueRange" priority="1003" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:useContext/f:valueRange/f:low" priority="1002" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:useContext/f:valueRange/f:high" priority="1001" mode="M4">
   ...
   <axsl:template match="f:StructureMap/f:group/f:rule/f:target" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:StructureMap/f:group/f:rule/f:target"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(f:context) or (f:contextType)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:context) or (f:contextType)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>smp-2: Must have a contextType if you have a context</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         <axsl:when test="not(f:element) or (f:context)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(f:element) or (f:context)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>smp-1: Can only have a element if you have a context</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
