...
<!--PATTERN DetectedIssue-->
   ...
   <axsl:template match="f:DetectedIssue" priority="1015" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:text/h:div" priority="1014" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:identifier/f:period" priority="1013" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:identifier/f:assigner" priority="1012" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:patient" priority="1011" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:patient/f:identifier/f:period" priority="1010" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:patient/f:identifier/f:assigner" priority="1009" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:author" priority="1008" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:author/f:identifier/f:period" priority="1007" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:author/f:identifier/f:assigner" priority="1006" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:implicated" priority="1005" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:implicated/f:identifier/f:period" priority="1004" mode="M4">
   ...
   <axsl:template match="f:DetectedIssue/f:implicated/f:identifier/f:assigner" priority="1003" mode="M4">
