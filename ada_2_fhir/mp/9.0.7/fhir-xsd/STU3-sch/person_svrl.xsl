   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">Person</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN Person-->
   ...
   <axsl:template match="f:Person" priority="1014" mode="M4">
   ...
   <axsl:template match="f:Person/f:text/h:div" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:text/h:div"/>
   ...
   <axsl:template match="f:Person/f:identifier/f:period" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Person/f:identifier/f:assigner" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:Person/f:name/f:period" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:name/f:period"/>
   ...
   <axsl:template match="f:Person/f:telecom" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Person/f:telecom/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:telecom/f:period"/>
   ...
   <axsl:template match="f:Person/f:address/f:period" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:address/f:period"/>
   ...
   <axsl:template match="f:Person/f:photo" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Person/f:managingOrganization" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:managingOrganization"/>
   ...
   <axsl:template match="f:Person/f:managingOrganization/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:managingOrganization/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Person/f:managingOrganization/f:identifier//f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:managingOrganization/f:identifier//f:assigner"/>
   ...
   <axsl:template match="f:Person/f:link/f:target" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:link/f:target"/>
   ...
   <axsl:template match="f:Person/f:link/f:target/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:link/f:target/f:identifier/f:period"/>
   ...
   <axsl:template match="f:Person/f:link/f:target/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:Person/f:link/f:target/f:identifier/f:assigner"/>
