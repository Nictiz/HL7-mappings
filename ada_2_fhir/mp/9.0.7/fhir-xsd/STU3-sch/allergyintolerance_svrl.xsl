...
<!--PATTERN AllergyIntolerance-->
   ...
   <axsl:template match="f:AllergyIntolerance" priority="1023" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="f:verificationStatus/@value!='entered-in-error' or not(exists(f:clinicalStatus))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="f:verificationStatus/@value!='entered-in-error' or not(exists(f:clinicalStatus))">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
   ...
   <axsl:template match="f:AllergyIntolerance/f:text/h:div" priority="1022" mode="M4">
   ...
   <axsl:template match="f:AllergyIntolerance/f:identifier/f:period" priority="1021" mode="M4">
   ...
   <axsl:template match="f:AllergyIntolerance/f:identifier/f:assigner" priority="1020" mode="M4">
   ...
   <axsl:template match="f:AllergyIntolerance/f:patient" priority="1019" mode="M4">
   ...
   <axsl:template match="f:AllergyIntolerance/f:patient/f:identifier/f:period" priority="1018" mode="M4">
   ...
   <axsl:template match="f:AllergyIntolerance/f:patient/f:identifier/f:assigner" priority="1017" mode="M4">
