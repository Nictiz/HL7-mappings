   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">ExpansionProfile</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN ExpansionProfile-->

   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">ExpansionProfile</svrl:text>

	<!--RULE -->

   <axsl:template match="f:ExpansionProfile" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:text/h:div" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:text/h:div"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:identifier/f:period" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:identifier/f:period"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:identifier/f:assigner" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:contact/f:telecom" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:contact/f:telecom/f:period" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueQuantity" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueRange" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueRange/f:low" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueRange/f:high" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:designation/f:include/f:designation" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:designation/f:include/f:designation"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="exists(f:language) or exists(f:use)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:language) or exists(f:use)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>exp-3: SHALL have at least one of language or use</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:ExpansionProfile/f:designation/f:exclude/f:designation" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:ExpansionProfile/f:designation/f:exclude/f:designation"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:language) or exists(f:use)">
               ...
               <svrl:text>exp-4: SHALL have at least one of language or use</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
