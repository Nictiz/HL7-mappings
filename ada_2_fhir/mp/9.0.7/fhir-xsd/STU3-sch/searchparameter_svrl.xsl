...
<!--PATTERN SearchParameter-->
   ...
   <axsl:template match="f:SearchParameter/f:component/f:definition" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:component/f:definition"/>
   ...
   <axsl:template match="f:SearchParameter/f:component/f:definition/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:component/f:definition/f:identifier/f:period"/>
   ...
   <axsl:template match="f:SearchParameter/f:component/f:definition/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:SearchParameter/f:component/f:definition/f:identifier/f:assigner"/>
