   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">OperationDefinition</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN OperationDefinition-->
   ...
   <axsl:template match="f:OperationDefinition" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition"/>
   ...
   <axsl:template match="f:OperationDefinition/f:text/h:div" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:text/h:div"/>
   ...
   <axsl:template match="f:OperationDefinition/f:contact/f:telecom" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:OperationDefinition/f:contact/f:telecom/f:period" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueQuantity" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueRange" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueRange/f:low" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:OperationDefinition/f:useContext/f:valueRange/f:high" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:OperationDefinition/f:base" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:base"/>
   ...
   <axsl:template match="f:OperationDefinition/f:base/f:identifier/f:period" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:base/f:identifier/f:period"/>
   ...
   <axsl:template match="f:OperationDefinition/f:base/f:identifier/f:assigner" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:base/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="exists(f:type) or exists(f:part)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:type) or exists(f:part)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:searchType)) or (f:type/@value = 'string')"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(f:searchType)) or (f:type/@value = 'string')">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>opd-2: A search type can only be specified for parameters of type string</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter/f:profile" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter/f:profile"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter/f:profile/f:identifier/f:period" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter/f:profile/f:identifier/f:period"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter/f:profile/f:identifier/f:assigner" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter/f:profile/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter/f:binding/f:valueSetReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter/f:binding/f:valueSetReference"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter/f:binding/f:valueSetReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter/f:binding/f:valueSetReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:OperationDefinition/f:parameter/f:binding/f:valueSetReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:OperationDefinition/f:parameter/f:binding/f:valueSetReference/f:identifier/f:assigner"/>
