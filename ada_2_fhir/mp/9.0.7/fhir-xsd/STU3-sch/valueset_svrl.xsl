...
<!--PATTERN ValueSet-->
   ...
   <axsl:template match="f:ValueSet" priority="1011" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="exists(f:compose) or exists(f:expansion)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:compose) or exists(f:expansion)">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-select-full-path"/>
               </axsl:attribute>
               <svrl:text>vsd-5: Value set SHALL contain at least one of a compose or an expansion element</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="f:ValueSet/f:text/h:div" priority="1010" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:identifier/f:period" priority="1009" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:identifier/f:assigner" priority="1008" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:contact/f:telecom" priority="1007" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:contact/f:telecom/f:period" priority="1006" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueQuantity" priority="1005" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueRange" priority="1004" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueRange/f:low" priority="1003" mode="M4">
   ...
   <axsl:template match="f:ValueSet/f:useContext/f:valueRange/f:high" priority="1002" mode="M4">
