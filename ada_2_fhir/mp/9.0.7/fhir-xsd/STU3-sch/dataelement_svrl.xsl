   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <axsl:attribute name="name">DataElement</axsl:attribute>
            <axsl:apply-templates/>
         </svrl:active-pattern>
...
<!--PATTERN DataElement-->
   ...
   <axsl:template match="f:DataElement" priority="1020" mode="M4">
   ...
   <axsl:template match="f:DataElement/f:text/h:div" priority="1019" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:text/h:div"/>
   ...
   <axsl:template match="f:DataElement/f:identifier/f:period" priority="1018" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:identifier/f:period"/>
   ...
   <axsl:template match="f:DataElement/f:identifier/f:assigner" priority="1017" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:identifier/f:assigner"/>
   ...
   <axsl:template match="f:DataElement/f:contact/f:telecom" priority="1016" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:contact/f:telecom"/>
   ...
   <axsl:template match="f:DataElement/f:contact/f:telecom/f:period" priority="1015" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:contact/f:telecom/f:period"/>
   ...
   <axsl:template match="f:DataElement/f:useContext/f:valueQuantity" priority="1014" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:useContext/f:valueQuantity"/>
   ...
   <axsl:template match="f:DataElement/f:useContext/f:valueRange" priority="1013" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:useContext/f:valueRange"/>
   ...
   <axsl:template match="f:DataElement/f:useContext/f:valueRange/f:low" priority="1012" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:useContext/f:valueRange/f:low"/>
   ...
   <axsl:template match="f:DataElement/f:useContext/f:valueRange/f:high" priority="1011" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:useContext/f:valueRange/f:high"/>
   ...
   <axsl:template match="f:DataElement/f:mapping" priority="1010" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:mapping"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(f:uri) or exists(f:name)">
               ...
               <svrl:text>dae-3: At least one of  name or uri SHALL be present</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/>
   ...
   <axsl:template match="f:DataElement/f:element" priority="1009" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="not(exists(f:base))"/>
         <axsl:otherwise>
      ...
      <axsl:choose>
         <axsl:when test="not(exists(f:slicing))"/>
         <axsl:otherwise>
   ...
   <axsl:template match="f:DataElement/f:element/f:slicing" priority="1008" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:slicing"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:max" priority="1007" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:max"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:type" priority="1006" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:type"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:minValueQuantity" priority="1005" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:minValueQuantity"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:maxValueQuantity" priority="1004" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:maxValueQuantity"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:binding" priority="1003" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:binding"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:binding/f:valueSetReference" priority="1002" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:binding/f:valueSetReference"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:period" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:period"/>
   ...
   <axsl:template match="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner"/>
