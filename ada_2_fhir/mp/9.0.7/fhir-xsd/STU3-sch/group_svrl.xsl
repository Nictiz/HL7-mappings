...
<!--PATTERN Group-->
   ...
   <axsl:template match="f:Group" priority="1012" mode="M4">
   ...
   <axsl:template match="f:Group/f:text/h:div" priority="1011" mode="M4">
   ...
   <axsl:template match="f:Group/f:identifier/f:period" priority="1010" mode="M4">
   ...
   <axsl:template match="f:Group/f:identifier/f:assigner" priority="1009" mode="M4">
   ...
   <axsl:template match="f:Group/f:characteristic/f:valueQuantity" priority="1008" mode="M4">
   ...
   <axsl:template match="f:Group/f:characteristic/f:valueRange" priority="1007" mode="M4">
   ...
   <axsl:template match="f:Group/f:characteristic/f:valueRange/f:low" priority="1006" mode="M4">
   ...
   <axsl:template match="f:Group/f:characteristic/f:valueRange/f:high" priority="1005" mode="M4">
