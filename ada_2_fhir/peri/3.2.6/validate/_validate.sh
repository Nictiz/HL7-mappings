...
igGZ=nictiz.fhir.nl.stu3.geboortezorg#1.3.3
igGZ=`dirname $0`/../../../../../Geboortezorg-STU3/profiles

ig2017=nictiz.fhir.nl.stu3.zib2017#2.2.10
ig2017=nictiz.fhir.nl.stu3.zib2017#2.3.0
ig2017=`dirname $0`/../../../../../Nictiz-STU3-Zib2017/Profiles\ -\ ZIB\ 2017/

inputFiles=`dirname $0`/../med_mij_uitbreiding_verloskunde_beschikbaarstellen/fhir_instance/*
