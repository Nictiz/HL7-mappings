...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:local="urn:fhir:stu3:functions" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template name="tobaccoUseEntry" match="tobacco_use[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doTobaccoUseEntry-2.1" as="element(f:entry)">
    ...
    <xsl:template name="zib-TobaccoUse-2.1" match="tobacco_use[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" as="element(f:Observation)" mode="doZibTobaccoUse-2.1">
        ...
        <xsl:for-each select="$in">
            <xsl:variable name="resource">
                ...
                <Observation>
                    ...
                    <xsl:for-each select="type_of_tobacco_used">
                        <component>
                            <code>
                                <coding>
                                    <system value="http://snomed.info/sct"/>
                    ...
                    <xsl:for-each select="observation_of_use/pack_years">
                        <component>
                            <code>
                                <coding>
                                    <system value="http://snomed.info/sct"/>
