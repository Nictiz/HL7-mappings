...
<xsl:stylesheet exclude-result-prefixes="#all" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:local="urn:fhir:stu3:functions" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:nf="http://www.nictiz.nl/functions" xmlns:uuid="http://www.uuid.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    <xsl:import href="../../../2_fhir_gebz_include_23.xsl"/>
    ...
    <xsl:variable name="usecase">prio1-huidige-zwangerschap</xsl:variable>
    ...
    <xsl:template match="/">
        <xsl:apply-templates select="//(prio1_huidige_zwangerschap)"/>
    </xsl:template>
    
    <xd:doc>
        <xd:desc>Build the Bundle with FHIR resources.</xd:desc>
    </xd:doc>
    <xsl:template name="ConversiePrio1Gegevens" match="prio1_huidige_zwangerschap">              
        <xsl:variable name="transactionBundle"> <!--as="element(f:Bundle)*"-->
            <Bundle xmlns="http://hl7.org/fhir">
                <id value="{concat('samenvatting-',$vrouwId,'-zwangerschap-',$pregnancyId)}"/>
