...
<!--    <xsl:import href="../../../../../../YATC-internal/ada-2-fhir/env/fhir/2_fhir_fhir_include.xsl"/>-->
    <xsl:import href="../../../../../../YATC-internal/ada-2-fhir/env/ketenzorg/2_fhir_ketenzorg_include.xsl"/>
    ...
    <xsl:template name="patientReference" match="patient|vrouw" mode="doPatientReference-2.1" as="element()*">
    ...
    <xsl:template name="patientEntry" match="patient|vrouw" mode="doPatientEntry-2.1" as="element(f:entry)">
    ...
    <xsl:template name="nl-core-patient-2.1" match="patient|vrouw" mode="doPatientResource-2.1"> <!-- as="element(f:Patient)?"> -->
        ...
        <xsl:for-each select="$in">
            <Patient>
                ...
                <xsl:for-each select="identificatienummer[@value] | patient_identificatienummer[@value] | patient_identification_number[@value] | burgerservicenummer[@value]">
                    <identifier>
                        <xsl:call-template name="id-to-Identifier">
                            <xsl:with-param name="in" select="."/>
                        </xsl:call-template>
