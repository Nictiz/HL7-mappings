This is a preliminary version of converting ADA instance with various Ketenzorg/Community Based Care 'building blocks' from a relatively simple dataset xml format in response type transactions to HL7 FHIR. 
