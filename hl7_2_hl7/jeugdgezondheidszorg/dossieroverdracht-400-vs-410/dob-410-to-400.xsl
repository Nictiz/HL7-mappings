...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:hl7="urn:hl7-org:v3" xmlns:exslt="http://exslt.org/common" exclude-result-prefixes="xs xd hl7 xsi exslt" version="1.0">
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b>Purpose:</xd:b> Conversie van een valide Dossieroverdrachtbericht op basis van BDS 4.1.0 (REPC_IN902120NL03) naar een valide versie op basis van BDS 4.0.2 (REPC_IN902120NL03). Regelt zelf het bijwerken van de weergavenamen bij rubrieken, groepen en elementen. Laat de weergavenamen van waarden ongemoeid.</xd:p>
            <xd:p>
                <xd:b>History:</xd:b>
            </xd:p>
            <xd:ul>
                <xd:li>04-08-2023 - dev</xd:li>
            </xd:ul>
    ...
    <xd:doc>
        <xd:desc> Apply BDS 4.1.0 templates to REPC_IN902120NL03</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:REPC_IN902120NL03">
        <REPC_IN902120NL03 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../schemas/REPC_IN902120NL03.xsd" xmlns="urn:hl7-org:v3">
            <xsl:apply-templates select="node()" mode="dob410"/>
        </REPC_IN902120NL03>
    </xsl:template>
    ...
    <xsl:template match="hl7:templateId[@root = '2.16.840.1.113883.2.4.6.10.100.10000']" mode="dob410">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob410"/>
    ...
    <xd:doc>
        <xd:desc>Soort toegevoegd bestand: 1169, 1..1 (W0084, KL_AN, Soort activiteit) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:code[@codeSystem = '2.16.840.1.113883.2.4.4.40.303']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Verwijsbrief: 03, 03 Naar: Anders -->
                <xsl:when test="@code = '03'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Verwijsbrief</originalText>
                </xsl:when>
                <!-- Uitnodigingsbrief: 04, 04 Naar: Anders -->
                <xsl:when test="@code = '04'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Uitnodigingsbrief</originalText>
                </xsl:when>
    ...
    <xd:doc>
        <xd:desc>Erfelijk bepaalde ziekte in de familie: 80, 1..1 (W0114, KL_AN, Erfelijke ziekten) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:value[@codeSystem = '2.16.840.1.113883.2.4.4.40.8']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Erfelijke aangeboren afwijking: 12, Text: Aangeboren afwijking -->
                <!-- De weergavenamen worden niet aangepast -->
                <!--<xsl:when test="@code = '12'">
                    <xsl:copy-of select="@code"/>
                    <xsl:copy-of select="@codeSystem"/>
                    <xsl:attribute name="displayName">
                        <xsl:value-of select="'Aangeboren afwijking'"/>
                    </xsl:attribute>
                </xsl:when>-->
                <!-- ADHD: 15 Naar: Anders -->
                <xsl:when test="@code = '15'">
                    ...
                    <originalText xmlns="urn:hl7-org:v3">ADHD</originalText>
                </xsl:when>
                <!-- ASS: 16 Naar: Anders -->
                <xsl:when test="@code = '16'">
                    ...
                    <originalText xmlns="urn:hl7-org:v3">ASS</originalText>
                </xsl:when>
                <!-- Allergie / astma / eczeem: 17 Naar: Anders -->
                <xsl:when test="@code = '17'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Allergie / astma / eczeem</originalText>
                </xsl:when>
                <!-- Hart- en vaatziekten < 50 jaar; plotseling overlijden: 18 Naar: Anders -->
                <xsl:when test="@code = '18'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Hart- en vaatziekten &lt; 50 jaar; plotseling overlijden</originalText>
                </xsl:when>
                <!-- Erfelijke huidafwijking: 19 Naar: Anders -->
                <xsl:when test="@code = '19'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Erfelijke huidafwijking</originalText>
                </xsl:when>
                <!-- Persistente spraak-taalstoornis en/of leerproblemen: 20 Naar: Anders -->
                <xsl:when test="@code = '20'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Persistente spraak-taalstoornis en/of leerproblemen</originalText>
                </xsl:when>
                <!-- Scoliose: 21 Naar: Anders -->
                <xsl:when test="@code = '21'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Scoliose</originalText>
                </xsl:when>
                <!-- Zindelijkheidsproblematiek: 22 Naar: Anders -->
                <xsl:when test="@code = '22'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Zindelijkheidsproblematiek</originalText>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="@* | node()" mode="dob410"/>
                </xsl:otherwise>
    ...
    <xd:doc>
        <xd:desc>Begeleider: 731, 0..* (W0193, KL_AN, Begeleider) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:code[@codeSystem = '2.16.840.1.113883.2.4.4.40.421']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Voogd: 13 Naar: Anders -->
                <xsl:when test="@code = '13'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Voogd</originalText>
                </xsl:when>
                <!-- Voogd: 14 Naar: Anders -->
                <xsl:when test="@code = '14'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Jeugdbeschermer (voorheen gezinsvoogd)</originalText>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="@* | node()" mode="dob410"/>
                </xsl:otherwise>
    ...
    <xsl:template match="hl7:reasonCode[@codeSystem = '2.16.840.1.113883.2.4.4.40.373']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Ouder-kindrelatie: 51 Naar: Anders -->
                <xsl:when test="@code = '51'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Ouder-kindrelatie</originalText>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="@* | node()" mode="dob410"/>
                </xsl:otherwise>
    ...
    <xd:doc>
        <xd:desc>Zindelijkheid: 324, 0..*   (W0209, KL_AN, Ontlasten/plassen/zindelijkheid) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:value[@codeSystem = '2.16.840.1.113883.2.4.4.40.46']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Zindelijk: 10 Naar: Anders -->
                <xsl:when test="@code = '10'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Zindelijk</originalText>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="@* | node()" mode="dob410"/>
                </xsl:otherwise>
    ...
    <xd:doc>
        <xd:desc>Bijzonderheden testis rechts/links: 422/1392, 0..*   (W0250, KL_AN, Bijzonderheden testis) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:value[@codeSystem = '2.16.840.1.113883.2.4.4.40.72']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Niet-scrotale testis, niet palpabel: 05 Naar: Anders -->
                <xsl:when test="@code = '05'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Niet-scrotale testis, niet palpabel</originalText>
                </xsl:when>
                <!-- Niet-scrotale testis, palpabel: 06 Naar: Anders -->
                <xsl:when test="@code = '06'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Niet-scrotale testis, palpabel</originalText>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="@* | node()" mode="dob410"/>
                </xsl:otherwise>
    ...
    <xd:doc>
        <xd:desc>Indicatie: 485, 0..* (W0619, KL_AN, Indicatie) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:value[@codeSystem = '2.16.840.1.113883.2.4.4.40.373']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Ouder-kindrelatie: 51 Naar: Anders -->
                <xsl:when test="@code = '51'">
    ...
    <xd:doc>
        <xd:desc>Screeningsinstrument psychosociale problematiek: 1341 0..1 (W0640, KL_AN, Screeningsinstrument PP) - waardelijst bijwerken</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:methodCode[@codeSystem = '2.16.840.1.113883.2.4.4.40.387']" mode="dob410">
        <xsl:copy>
            <xsl:choose>
                <!-- Cosos: 11 Naar: Anders -->
                <xsl:when test="@code = '11'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">Cosos</originalText>
                </xsl:when>
                <!-- GIZ: 12 Naar: Anders -->
                <xsl:when test="@code = '12'">
                    <xsl:attribute name="nullFlavor">
                    ...
                    <originalText xmlns="urn:hl7-org:v3">GIZ</originalText>
                </xsl:when>
                <!-- SDQ ouders 2-4 jaar: 13 Naar: Anders -->
                <xsl:when test="@code = '13'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">SDQ ouders 2-4 jaar</originalText>
                </xsl:when>
                <!-- SDQ ouders 1-17 jaar: 14 Naar: Anders -->
                <xsl:when test="@code = '14'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">SDQ ouders 4-17</originalText>
                </xsl:when>
                <!-- SDQ leerkrachten 2-4 jaar: 15 Naar: Anders -->
                <xsl:when test="@code = '15'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">SDQ leerkrachten 2-4 jaar</originalText>
                </xsl:when>
                <!-- SDQ ouders 4-17 jaar: 16 Naar: Anders -->
                <xsl:when test="@code = '16'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">SDQ leerkrachten 4-17 jaar</originalText>
                </xsl:when>
                <!-- SDQ jongeren 11-17 jaar: 17 Naar: Anders -->
                <xsl:when test="@code = '17'">
                    <xsl:attribute name="nullFlavor">
                        <xsl:value-of select="'OTH'"/>
                    </xsl:attribute>
                    <originalText xmlns="urn:hl7-org:v3">SDQ jongeren 11-17</originalText>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="@* | node()" mode="dob410"/>
                </xsl:otherwise>
    ...
    <xsl:template match="hl7:code[@codeSystem = '2.16.840.1.113883.2.4.4.40.391'] | hl7:code[@codeSystem = '2.16.840.1.113883.2.4.4.40.393'] | hl7:code[@codeSystem = '2.16.840.1.113883.2.4.4.40.267']" mode="dob410">
    ...
    <xsl:template match="text()[normalize-space() = '']" mode="dob410"/>

    <xd:doc>
        <xd:desc>Just copy as-is</xd:desc>
    </xd:doc>
    <xsl:template match="@* | node()" mode="dob410">
        <xsl:copy>
            <xsl:apply-templates select="@* | node()" mode="dob410"/>
        </xsl:copy>
    </xsl:template>
    ...
    <xsl:template name="maakNonBDSData">
        ...
        <component1 typeCode="COMP" xmlns="urn:hl7-org:v3">
            <nonBDSData classCode="OBS" moodCode="EVN">
                ...
                <xsl:apply-templates select="hl7:code" mode="dob410"/>
                <text>
                ...
                <pertainsTo>
                    <categoryInBDS>
                        <xsl:apply-templates select="ancestor::hl7:rubricCluster/hl7:code" mode="dob410"/>
                    </categoryInBDS>
                </pertainsTo>
            </nonBDSData>
        </component1>
