...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:hl7="urn:hl7-org:v3" xmlns:exslt="http://exslt.org/common" exclude-result-prefixes="xs xd hl7 xsi exslt" version="1.0">
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b>Purpose:</xd:b> Conversie van een valide Dossieroverdrachtbericht op basis van BDS 3.2.7 (REPC_IN902120NL) naar een valide versie op basis van BDS 4.0.1 (REPC_IN902120NL03). Regelt zelf het bijwerken van de weergavenamen bij rubrieken, groepen en elementen. Laat de weergavenamen van waarden ongemoeid.</xd:p>
            <xd:p>
                <xd:b>History:</xd:b>
            </xd:p>
            <xd:ul>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R020'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            ...
            <xsl:apply-templates select="hl7:*[not(local-name() = 'code' or local-name() = 'templateId')]" mode="dob420"/>
        </xsl:copy>
    </xsl:template>-->
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R021'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R022'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R023'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R024'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R025'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R026'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R030'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R031'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R032'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R034'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R038'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        ...
        <xsl:copy>
            ...
            <xsl:apply-templates select="hl7:*[not(local-name() = 'code' or local-name() = 'templateId' or hl7:observation[hl7:code[@code = '851'][@codeSystem = '2.16.840.1.113883.2.4.4.40.267']])]" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R039'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:rubricCluster[hl7:code[@code = 'R040'][@codeSystem = '2.16.840.1.113883.2.4.4.40.391']]" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
    ...
    <xsl:template match="hl7:nonBDSData | hl7:metaData" mode="dob420">
        <xsl:copy>
            <xsl:apply-templates select="@*" mode="dob420"/>
            <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
            <xsl:apply-templates select="hl7:code" mode="dob420"/>
            ...
            <xsl:apply-templates select="hl7:author" mode="dob420"/>
            <xsl:apply-templates select="hl7:pertainsTo" mode="dob420"/>
        </xsl:copy>
    </xsl:template>
    ...
    <xsl:template name="rubricCluster18">
        <xsl:apply-templates select="hl7:templateId" mode="dob420"/>
        <xsl:apply-templates select="hl7:id" mode="dob420"/>
        <xsl:apply-templates select="hl7:code" mode="dob420"/>
        ...
        <xsl:apply-templates select="hl7:effectiveTime" mode="dob420"/>
        <xsl:apply-templates select="hl7:reasonCode" mode="dob420"/>
        <xsl:apply-templates select="hl7:performer" mode="dob420"/>
        <xsl:apply-templates select="hl7:author" mode="dob420"/>
        <xsl:apply-templates select="hl7:consultant" mode="dob420"/>
        <xsl:apply-templates select="hl7:escort" mode="dob420"/>
        <xsl:apply-templates select="hl7:inFulfillmentOf" mode="dob420"/>
        ...
        <xsl:apply-templates select="hl7:pertinentInformation" mode="dob420"/>
        ...
        <xsl:apply-templates select="hl7:component1" mode="dob420"/>
        <xsl:apply-templates select="hl7:component2" mode="dob420"/>
        <xsl:apply-templates select="hl7:component3" mode="dob420"/>
        <xsl:apply-templates select="hl7:component4" mode="dob420"/>
        <xsl:apply-templates select="hl7:component5" mode="dob420"/>
        <!--Verwijder reden voor annulering (subjectOf) bij activiteit Contactmomentafspraak-->
        <xsl:if test="not(@moodCode = 'INT')">
            <xsl:apply-templates select="hl7:subjectOf" mode="dob420"/>
        </xsl:if>
        <xsl:apply-templates select="hl7:subjectOf1" mode="dob420"/>
        <xsl:apply-templates select="hl7:subjectOf2" mode="dob420"/>
    </xsl:template>
    ...
    <xsl:template name="maakNonBDSData">
        ...
        <component1 typeCode="COMP" xmlns="urn:hl7-org:v3">
            <nonBDSData classCode="OBS" moodCode="EVN">
                ...
                <pertainsTo>
                    <categoryInBDS>
                        <xsl:apply-templates select="ancestor::hl7:rubricCluster/hl7:code" mode="dob420"/>
                    </categoryInBDS>
                </pertainsTo>
            </nonBDSData>
        </component1>
