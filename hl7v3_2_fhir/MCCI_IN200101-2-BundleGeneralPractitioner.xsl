...
-->
<xsl:stylesheet xmlns:uuid="java.util.UUID" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:hl7="urn:hl7-org:v3" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:f="http://hl7.org/fhir" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all" version="2.0">
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Author:</xd:b> Alexander Henket, Nictiz</xd:p>
            <xd:p><xd:b>Created on:</xd:b> Jan 15, 2018</xd:p>
            <xd:p><xd:b>Purpose:</xd:b> This XSL was created to facilitate mapping HL7 V3 MCCI_IN200101 as specified on the Dutch national LSP version <xd:a href="http://decor.nictiz.nl/pub/vzvz/index.php?prefix=kz-vzvz-">1.0</xd:a>, to HL7 FHIR STU3 profiles for the GP <xd:a href="https://simplifier.net/NictizSTU3-ZIB2017/~resources">https://simplifier.net/NictizSTU3-ZIB2017/~resources</xd:a>.</xd:p>
            <xd:p><xd:b>History:</xd:b> <xd:ul>
                <xd:li>2018-08-16 version 0.1 <xd:ul><xd:li>Initial example.</xd:li></xd:ul></xd:li>
            </xd:ul></xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:variable name="theInput" select="."/>
    <xsl:key name="keyComponentElementId" match="$theInput//hl7:component/*" use="hl7:id/concat(@root, @extension)"/>
    ...
    <xsl:param name="bundle-id" select="uuid:randomUUID()"/>
    ...
    <xsl:template match="hl7:MCCI_IN200101">
        ...
        <Bundle xmlns="http://hl7.org/fhir" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://hl7.org/fhir http://hl7.org/fhir/STU3/bundle.xsd">
            ...
            <xsl:variable name="entries" as="element(f:entry)*">
                <!-- VZVZ Opleveren Alerts - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.18&effectiveDate=2015-06-01T00%3A00%3A00 -->
                <xsl:apply-templates select="hl7:REPC_IN990121NL"/>
                <!-- VZVZ Opleveren Algemene Bepalingen - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.8&effectiveDate=2014-08-18T00%3A00%3A00 -->
                <xsl:apply-templates select="hl7:POOB_IN990003NL"/>
                <!-- VZVZ Opleveren Allergie Intoleranties - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.20&effectiveDate=2015-06-01T00%3A00%3A00 -->
                <xsl:apply-templates select="hl7:REPC_IN990131NL"/>
                <!-- VZVZ Opleveren Contactmomenten - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.10&effectiveDate=2014-08-18T00%3A00%3A00 -->
                <xsl:apply-templates select="hl7:PRPA_IN900350NL"/>
                <!-- VZVZ Opleveren Contactverslagen - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.14&effectiveDate=2015-06-01T00:00:00 -->
                <xsl:apply-templates select="hl7:REPC_IN990101NL"/>
                <!-- VZVZ Opleveren Labbepalingen - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.6&effectiveDate=2018-04-24T15%3A57%3A22 -->
                <xsl:apply-templates select="hl7:POLB_IN364001NL03"/>
                <!-- VZVZ Opleveren Medicatieafspraken - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.10&effectiveDate=2014-08-18T00%3A00%3A00 -->
                <xsl:apply-templates select="hl7:QUMA_IN991203NL02"/>
                <!-- VZVZ Opleveren Overdrachtconcerns - http://decor.nictiz.nl/art-decor/decor-templates-/-opv-vzvz-?id=2.16.840.1.113883.2.4.3.111.3.3.10.16&effectiveDate=2015-06-01T00%3A00%3A00 -->
                <xsl:apply-templates select="hl7:REPC_IN990111NL"/>
    ...
    <xd:doc>
        <xd:desc>Handle HL7 V3 VZVZ Opleveren Alerts. Build a FHIR Bundle of type searchset unless we are in a V3 Batch Response (MCCI_IN200101), then we assume that part was covered already</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:REPC_IN990121NL | hl7:POOB_IN990003NL | hl7:REPC_IN990131NL | hl7:PRPA_IN900350NL | hl7:REPC_IN990101NL | hl7:POLB_IN364001NL03 | hl7:QUMA_IN991203NL02 | hl7:REPC_IN990111NL">
        <xsl:choose>
    ...
    <xsl:variable name="gTemplateIDOrganizerAlertsV2">2.16.840.1.113883.2.4.3.11.60.66.10.18</xsl:variable>
    <xsl:variable name="gTemplateIDOrganizerAlertsV3">2.16.840.1.113883.2.4.3.11.60.66.10.73</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Alerts for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = ($gTemplateIDOrganizerAlertsV2, $gTemplateIDOrganizerAlertsV3)]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="AlertsV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerAlgemeneBepalingenV2">2.16.840.1.113883.2.4.3.11.60.66.10.8</xsl:variable>
    <xsl:variable name="gTemplateIDOrganizerAlgemeneBepalingenV3">2.16.840.1.113883.2.4.3.11.60.66.10.76</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Algemene Bepalingen for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = ($gTemplateIDOrganizerAlgemeneBepalingenV2, $gTemplateIDOrganizerAlgemeneBepalingenV3)]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="AlgemeneBepalingenV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerAllergieIntolerantiesV2">2.16.840.1.113883.2.4.3.11.60.66.10.20</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Allergie Intoleranties for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerAllergieIntolerantiesV2]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="AllergieIntolerantiesV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerContactmomentenV2">2.16.840.1.113883.2.4.3.11.60.66.10.10</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Contactmomenten for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerContactmomentenV2]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:encounter" mode="ContactmomentenV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerContactverslagenV2">2.16.840.1.113883.2.4.3.11.60.66.10.14</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Contactverslagen for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerContactverslagenV2]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="ContactverslagenV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerLabbepalingenV2">2.16.840.1.113883.2.4.3.11.60.66.10.6</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Labbepalingen for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerLabbepalingenV2]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="LabbepalingenV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    <xsl:variable name="gTemplateIDOrganizerLabbepalingenV3">2.16.840.1.113883.2.4.3.11.60.66.10.77</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Labbepalingen for version 3</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerLabbepalingenV3]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="LabbepalingenV3">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerMedicatieafsprakenv2">2.16.840.1.113883.2.4.3.11.60.66.10.12</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Medicatieafspraken for version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerMedicatieafsprakenv2]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:substanceAdministration" mode="MedicatieafsprakenV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    <xsl:variable name="gTemplateIDOrganizerMedicatieafsprakenv3">2.16.840.1.113883.2.4.3.11.60.66.10.74</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with Medicatieafspraken for version 3</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerMedicatieafsprakenv3]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:substanceAdministration" mode="MedicatieafsprakenV3">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    
    <xsl:variable name="gTemplateIDOrganizerOverdrachtConcernsv2">2.16.840.1.113883.2.4.3.11.60.66.10.16</xsl:variable>
    <xd:doc>
        <xd:desc>Handle ControlActProcess/subject/organizer with OverdrachtConcerns version 2</xd:desc>
    </xd:doc>
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:organizer[hl7:templateId/@root = $gTemplateIDOrganizerOverdrachtConcernsv2]" as="element()*">
        <xsl:apply-templates select="hl7:component/hl7:observation" mode="OverdrachtConcernsV2">
            <xsl:with-param name="patient" select="hl7:recordTarget/hl7:patientRole"/>
        </xsl:apply-templates>
    </xsl:template>
    ...
    <xsl:template match="*[hl7:id[@root = $oidUZIPersons]]" mode="doPractitionerRole">
        <xsl:variable name="idPractitioner" select="hl7:id[@root = $oidUZIPersons]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
        ...
        <entry xmlns="http://hl7.org/fhir">
            <fullUrl value="urn:uuid:{uuid:randomUUID()}"/>
            <resource>
                <PractitionerRole>
                    <meta>
                        ...
                        <div xmlns="http://www.w3.org/1999/xhtml">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Naam: <xsl:value-of select="$namePractitioner/normalize-space()"/></td>
                                    </tr>
                                    <tr>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <xsl:value-of select="$namePractitioner/normalize-space()"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Contact</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <xsl:value-of select="$addrPractitioner//text()"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <xsl:template match="hl7:observation" mode="AlertsV2">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
            ...
            <resource>
                <Flag xmlns="http://hl7.org/fhir">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><xsl:value-of select="$alertName"/></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <extension url="http://hl7.org/fhir/StructureDefinition/flag-detail">
                        <valueReference>
                            <reference value="{$uriEpisodeOfCare}"/>
                            <xsl:if test="$episodeofCare/hl7:text">
                    ...
                    <code>
                        <text value="{$alertName}"/>
                    </code>
                    <subject>
                        <xsl:for-each select="$patient/hl7:id[@root][@extension]">
                            <identifier>
                                <system value="{local:getUri(@root)}"/>
                                <value value="{@extension}"/>
                            </identifier>
                        </xsl:for-each>
                        <xsl:if test="$patient/hl7:patient/hl7:name">
                            <display value="{$patient/hl7:patient/hl7:name[1]/normalize-space()}"/>
                        </xsl:if>
                    </subject>
                    ...
                    <xsl:if test="$author">
                        <author>
                            <xsl:variable name="idAuthor" select="$author/hl7:id[@root = $oidUZIPersons]/concat('urn:oid:', string-join((@root, @extension), '.'))"/>
    ...
    <xsl:template match="hl7:observation" mode="AlgemeneBepalingenV2">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
        
        <!--<xsl:variable name="episodeOfCareRef" select="hl7:entryRelationship/hl7:act/hl7:id/string-join((@root, @extension),'.')" as="xs:string+"/>
        <xsl:variable name="episodeofCare" select="//hl7:component/*[hl7:id/string-join((@root, @extension),'.') = $episodeOfCareRef]" as="element()?"/>
    ...
    <xsl:template match="hl7:encounter" mode="ContactmomentenV2">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
    ...
    <xsl:template match="hl7:observation" mode="LabbepalingenV2">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
    ...
    <xsl:template match="hl7:observation" mode="LabbepalingenV3">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
    ...
    <xsl:template match="hl7:substanceAdministration" mode="MedicatieafsprakenV2">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
    ...
    <xsl:template match="hl7:substanceAdministration" mode="MedicatieafsprakenV3">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
    ...
    <xsl:template match="hl7:observation" mode="OverdrachtConcernsV2">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author[ancestor::hl7:organizer]/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()?"/>
    ...
    <xsl:template match="hl7:episodeOfCondition" mode="episode">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idEpisodeOfCare" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
        ...
        <entry xmlns="http://hl7.org/fhir">
            ...
            <resource>
                <EpisodeOfCare>
                    ...
                    <xsl:for-each select="hl7:reason/hl7:ObswrvationDx">
                        <xsl:variable name="idReason" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
                        <diagnosis>
                            <condition>
                    ...
                    <patient>
                        ...
                        <xsl:if test="$patient/hl7:Person/hl7:name">
                            <display value="{$patient/hl7:Person/hl7:name[1]/normalize-space()}"/>
                        </xsl:if>
                    </patient>
                    <xsl:if test="$author">
                        <careManager>
        ...
        <xsl:for-each select="$flags">
            <xsl:variable name="idFlag" select="if (hl7:id) then hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.')) else concat('urn:uuid:', uuid:randomUUID())"/>
            <entry xmlns="http://hl7.org/fhir">
    ...
    <xsl:template match="hl7:ObservationDx" mode="diagnosis">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idReason" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
            ...
            <resource>
                <Condition>
                    ...
                    <xsl:if test="$authorReason">
                        <asserter>
                            <xsl:variable name="idAuthor" select="$authorReason/hl7:id[@root = $oidUZIPersons]/concat('urn:oid:', string-join((@root, @extension), '.'))"/>
                            <xsl:variable name="nameAuthor" select="$commonEntries[f:fullUrl[@value = $idAuthor]][1]/f:resource/*/f:name"/>
                            <reference value="{$idAuthor}"/>
                            <xsl:if test="$nameAuthor">
                                <display value="{$nameAuthor/*/@value}"/>
    ...
    <xsl:template match="hl7:encounter" mode="encounterreport">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idEncounter" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
            ...
            <resource>
                <Encounter>
                    ...
                    <xsl:for-each select="hl7:performer">
                        <xsl:variable name="idParticipant" select="*/hl7:id[@root = $oidUZIPersons]/concat('urn:oid:', string-join((@root, @extension), '.'))"/>
                    ...
                    <xsl:for-each select="*/hl7:ObservationDx">
                        <xsl:variable name="idObservation" select="if (hl7:id) then hl7:id[1]/concat('urn:oid:', string-join((@root, @extension), '.')) else concat('urn:uuid:', uuid:randomUUID())"/>
                        <diagnosis>
                            <condition>
    ...
    <xsl:template match="hl7:Prescription" mode="medication">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idPrescription" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
        <xsl:variable name="medication" select="hl7:directTarget/hl7:prescribedMedication/hl7:MedicationKind"/>
        <xsl:variable name="idMedication" select="concat('urn:uuid:',uuid:randomUUID())"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()"/>
        <xsl:variable name="idAuthor" select="$author/hl7:id[@root = $oidUZIPersons]/concat('urn:oid:', string-join((@root, @extension), '.'))"/>
        <xsl:variable name="nameAuthor" select="$commonEntries[f:fullUrl[@value = $idAuthor]][1]/f:resource/*/f:name"/>
        <entry xmlns="http://hl7.org/fhir">
    ...
    <xsl:template match="hl7:observation[not(hl7:code/@codeSystem = '2.16.840.1.113883.6.1')]" mode="results">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idObservation" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()"/>
        <xsl:variable name="idAuthor" select="$author/hl7:id[@root = $oidUZIPersons]/concat('urn:oid:', string-join((@root, @extension), '.'))"/>
        <xsl:variable name="nameAuthor" select="$commonEntries[f:fullUrl[@value = $idAuthor]][1]/f:resource/*/f:name"/>
        <entry xmlns="http://hl7.org/fhir">
    ...
    <xsl:template match="hl7:ContraIndication | hl7:ObservationIntolerance" mode="allergyintolerance">
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idAllergyIntolerance" select="hl7:id[1]/concat('urn:oid:',string-join((@root, @extension),'.'))"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()"/>
        <entry xmlns="http://hl7.org/fhir">
